...
export function getPlaySvg(size: string | number): string {
...
export function getPauseSvg(size: string | number): string {
    return `<svg xmlns='http://www.w3.org/2000/svg' width='${size}' height='${size}' fill='currentColor'  viewBox='0 0 16 16'>
        <path d='M5.5 3.5A1.5 1.5 0 0 1 7 5v6a1.5 1.5 0 0 1-3 0V5a1.5 1.5 0 0 1 1.5-1.5zm5 0A1.5 1.5 0 0 1 12 5v6a1.5 1.5 0 0 1-3 0V5a1.5 1.5 0 0 1 1.5-1.5z'/>
    </svg>`;
}

export function getLoopSvg(size: string | number): string {
...
export function getTextSvg(size: string | number): string {
...
export function getForwardSvg(size: string | number): string {
...
export function getBackwardSvg(size: string | number): string {
...
export function getVolumeSvg(size: string | number): string {
...
export function getEmptyMicSvg(size: number): string {
...
export function getMicSvg(size: number): string {
...
export function getMuteSvg(size: string | number): string {
...
export function getDrumsSvg(size: string | number): string {
...
export function getNoteSvg(size: string | number): string {
...
export function getGearSvg(size: string | number): string {
...
export function getDoubleNoteSvg(size: string | number): string {
...
export function getDownArrowSvg(size: string | number): string {
...
export function getLockSVG(size: number): string {
...
export function getUnlockSVG(size: number): string {
...
export function getHourglassSvg(size: string | number): string {
...
export function getExclamationSvg(size: string | number): string {
...
export function getCheckSvg(size: string | number): string {
...
export function getShuffleSvg(size: string | number): string {
    return `<svg xmlns='http://www.w3.org/2000/svg' width='${size}' height='${size}' stroke='currentColor' class='bi bi-shuffle' viewBox='-3 -3 22 22'>
...
export function getSpeedSvg(size: string | number): string {
