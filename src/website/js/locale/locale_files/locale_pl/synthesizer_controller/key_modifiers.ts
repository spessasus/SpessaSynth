export const keyModifiers = {
    ...
    detailedDescription:
        "To menu pozwala Ci na modyfikację danych klawiszy na danym kanale.\n" +
    ...
    selectedChannel: {
        title: "Wybrany kanał",
        description:
            "Kanał do którego należy klawisz który chcesz zmodyfikować."
    },
    ...
    modifyKey: {
        ...
        velocity: {
            title: "Siła nacisku",
            description:
                "Siła nacisku dla tego klawisza. Pozostaw -1 dla braku zmian."
        },
        preset: {
        ...
        gain: {
            title: "Głośność",
            description:
                "Liniowy przyrost głośności dla tego klawisza. Pozostaw na 1 dla braku zmian."
        },
        apply: {
            title: "Zastosuj",
