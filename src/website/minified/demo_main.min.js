...
`)||""),this.midiName=this.midiName.trim(),this.midiNameUsesFileName=!1,this.midiName.length===0){x("%cNo name detected. Using the alt name!",f.info),this.midiName=ro(this.fileName),this.midiNameUsesFileName=!0,this.rawMidiName=new Uint8Array(this.midiName.length);for(let a=0;a<this.midiName.length;a++)this.rawMidiName[a]=this.midiName.charCodeAt(a)}else x(`%cMIDI Name detected! %c"${this.midiName}"`,f.info,f.recognized);let u=!0;for(let a of this.lyrics)if(a[0]===32||a[a.length-1]===32){u=!1;break}u&&(this.lyrics=this.lyrics.map(a=>{if(a[a.length-1]===45)return a;let g=new Uint8Array(a.length+1);return g.set(a,0),g[a.length]=32,g})),this.duration=mo(this.lastVoiceEventTick,this),x("%cSuccess!",f.recognized),j()}flush(){for(let e of this.tracks)e.sort((t,o)=>t.ticks-o.ticks);this._parseInternal()}};function mo(i,e){let t=0;for(;i>0;){let o=e.tempoChanges.find(s=>s.ticks<i),n=i-o.ticks;t+=n*60/(o.tempo*e.timeDivision),i-=n}return t}var po={backwards:0,forwards:1,shuffleOn:2,shuffleOff:3},ke={loadNewSongList:0,pause:1,stop:2,play:3,setTime:4,changeMIDIMessageSending:5,setPlaybackRate:6,setLoop:7,changeSong:8,getMIDI:9,setSkipToFirstNote:10,setPreservePlaybackState:11},lt={midiEvent:0,songChange:1,textEvent:2,timeChange:3,pause:4,getMIDI:5,midiError:6,metaEvent:7,loopCountChange:8};var $n={duration:99999,firstNoteOn:0,loop:{start:0,end:123456},lastVoiceEventTick:123456,lyrics:[],copyright:"",midiPorts:[],midiPortChannelOffsets:[],tracksAmount:0,tempoChanges:[{ticks:0,tempo:120}],fileName:"NOT_LOADED.mid",midiName:"Loading...",rawMidiName:new Uint8Array([76,111,97,100,105,110,103,46,46,46]),usedChannelsOnTrack:[],timeDivision:0,keyRange:{min:0,max:127},isEmbedded:!1,RMIDInfo:{},bankOffset:0,midiNameUsesFileName:!1,format:0};var xa={skipToFirstNoteOn:!0,autoPlay:!0,preservePlaybackState:!1},Wo=class{onError;onTextEvent;midiData;onSongChange={};onTimeChange={};onSongEnded={};onTempoChange={};onMetaEvent={};currentTempo=120;songIndex=0;_getMIDIResolve=void 0;hasDummyData=!0;isFinished=!1;duration=0;pausedTime=void 0;constructor(e,t,o=xa){this.ignoreEvents=!1,this.synth=t,this.highResTimeOffset=0,this.absoluteStartTime=this.synth.currentTime,this.synth.sequencerCallbackFunction=this._handleMessage.bind(this),this._skipToFirstNoteOn=o?.skipToFirstNoteOn??!0,this._preservePlaybackState=o?.preservePlaybackState??!1,this._skipToFirstNoteOn===!1&&this._sendMessage(ke.setSkipToFirstNote,!1),this._preservePlaybackState===!0&&this._sendMessage(ke.setPreservePlaybackState,!0),this.loadNewSongList(e,o?.autoPlay??!0),window.addEventListener("beforeunload",this.resetMIDIOut.bind(this))}_loop=!0;get loop(){return this._loop}set loop(e){this._sendMessage(ke.setLoop,[e,this._loopsRemaining]),this._loop=e}_loopsRemaining=-1;get loopsRemaining(){return this._loopsRemaining}set loopsRemaining(e){this._loopsRemaining=e,this._sendMessage(ke.setLoop,[this._loop,e])}_playbackRate=1;get playbackRate(){return this._playbackRate}set playbackRate(e){this._sendMessage(ke.setPlaybackRate,e),this.highResTimeOffset*=e/this._playbackRate,this._playbackRate=e}_shuffleSongs=!1;get shuffleSongs(){return this._shuffleSongs}set shuffleSongs(e){this._shuffleSongs=e,e?this._sendMessage(ke.changeSong,po.shuffleOn):this._sendMessage(ke.changeSong,po.shuffleOff)}get skipToFirstNoteOn(){return this._skipToFirstNoteOn}set skipToFirstNoteOn(e){this._skipToFirstNoteOn=e,this._sendMessage(ke.setSkipToFirstNote,this._skipToFirstNoteOn)}get preservePlaybackState(){return this._preservePlaybackState}set preservePlaybackState(e){this._preservePlaybackState=e,this._sendMessage(ke.setPreservePlaybackState,e)}get currentTime(){return this.pausedTime!==void 0?this.pausedTime:(this.synth.currentTime-this.absoluteStartTime)*this._playbackRate}set currentTime(e){this._preservePlaybackState||this.unpause(),this._sendMessage(ke.setTime,e)}get currentHighResolutionTime(){if(this.pausedTime!==void 0)return this.pausedTime;let e=this.highResTimeOffset,t=this.absoluteStartTime,o=(performance.now()/1e3-t)*this._playbackRate,n=e+o,s=this.currentTime,A=.01*this._playbackRate,c=s-n;return this.highResTimeOffset+=c*A,n=this.highResTimeOffset+o,n}get paused(){return this.pausedTime!==void 0}addOnSongChangeEvent(e,t){this.onSongChange[t]=e}addOnSongEndedEvent(e,t){this.onSongEnded[t]=e}addOnTimeChangeEvent(e,t){this.onTimeChange[t]=e}addOnTempoChangeEvent(e,t){this.onTempoChange[t]=e}addOnMetaEvent(e,t){this.onMetaEvent[t]=e}resetMIDIOut(){if(this.MIDIout){for(let e=0;e<16;e++)this.MIDIout.send([G.controllerChange|e,120,0]),this.MIDIout.send([G.controllerChange|e,123,0]);this.MIDIout.send([G.reset])}}_sendMessage(e,t=void 0){this.synth.post({channelNumber:-1,messageType:ce.sequencerSpecific,messageData:{messageType:e,messageData:t}})}nextSong(){this._sendMessage(ke.changeSong,po.forwards)}previousSong(){this._sendMessage(ke.changeSong,po.backwards)}_callEvents(e,t){for(let o in e){let n=e[o];try{n(t)}catch(s){Z(`Failed to execute callback for ${n[0]}:`,s)}}}_handleMessage(e,t){if(!this.ignoreEvents)switch(e){case lt.midiEvent:let o=t;if(this.MIDIout&&o[0]>=128){this.MIDIout.send(o);return}break;case lt.songChange:let n=t[0];this.songIndex=t[1],this.midiData=n,this.hasDummyData=!1,this.absoluteStartTime=0,this.duration=this.midiData.duration,this._callEvents(this.onSongChange,n),t[2]===!0&&this.unpause();break;case lt.textEvent:this.onTextEvent&&this.onTextEvent(...t);break;case lt.timeChange:let s=this.synth.currentTime-t;this._callEvents(this.onTimeChange,s),this._recalculateStartTime(s),this.paused&&this._preservePlaybackState?this.pausedTime=s:this.unpause();break;case lt.pause:this.pausedTime=this.currentTime,this.isFinished=t,this.isFinished&&this._callEvents(this.onSongEnded,void 0);break;case lt.midiError:if(this.onError)this.onError(t);else throw new Error("Sequencer error: "+t);return;case lt.getMIDI:this._getMIDIResolve&&this._getMIDIResolve(uo.copyFrom(t));break;case lt.metaEvent:if(t[0]===G.setTempo){let c=new L(t[1]),r=6e7/_t(c,3);this.currentTempo=Math.round(r*100)/100,this.onTempoChange&&this._callEvents(this.onTempoChange,this.currentTempo)}this._callEvents(this.onMetaEvent,t);break;case lt.loopCountChange:this._loopsRemaining=t,this._loopsRemaining===0&&(this._loop=!1);break;default:break}}_recalculateStartTime(e){this.absoluteStartTime=this.synth.currentTime-e/this._playbackRate,this.highResTimeOffset=(this.synth.currentTime-performance.now()/1e3)*this._playbackRate}async getMIDI(){return new Promise(e=>{this._getMIDIResolve=e,this._sendMessage(ke.getMIDI,void 0)})}loadNewSongList(e,t=!0){this.pause(),this.midiData=$n,this.hasDummyData=!0,this.duration=99999,this._sendMessage(ke.loadNewSongList,[e,t]),this.songIndex=0,this.songsAmount=e.length,this.songsAmount>1&&(this.loop=!1),t===!1&&(this.pausedTime=this.currentTime)}connectMidiOutput(e){this.resetMIDIOut(),this.MIDIout=e,this._sendMessage(ke.changeMIDIMessageSending,e!==void 0),this.currentTime-=.1}pause(){if(this.paused){Z("Already paused");return}this.pausedTime=this.currentTime,this._sendMessage(ke.pause)}unpause(){this.pausedTime=void 0,this.isFinished=!1}play(e=!1){this.isFinished&&(e=!0),this._recalculateStartTime(this.pausedTime||0),this.unpause(),this._sendMessage(ke.play,e)}stop(){this._sendMessage(ke.stop)}};var Co=["Shift_JIS","windows-1250","utf-8","utf-16","utf-16le","utf-16be","latin1","ISO-8859-1","ISO-8859-2","ISO-8859-3","ISO-8859-4","ISO-8859-5","ISO-8859-6","ISO-8859-7","ISO-8859-8","ISO-8859-9","ISO-8859-10","ISO-8859-11","ISO-8859-13","ISO-8859-14","ISO-8859-15","ISO-8859-16","windows-1251","windows-1252","windows-1253","windows-1254","windows-1255","windows-1256","windows-1257","windows-1258","EUC-JP","ISO-2022-JP","EUC-KR","Big5","GB18030"];function es(i){return`<svg xmlns='http://www.w3.org/2000/svg' width='${i}' height='${i}' fill='currentColor' viewBox='0 0 16 16'>
...
</svg>`}function fo(i){return`<svg xmlns='http://www.w3.org/2000/svg' width='${i*.8}' height='${i*.8}' fill='currentColor' class='bi bi-lock-fill' viewBox='0 0 16 16'>
  ...
  <path d='M11 1a2 2 0 0 0-2 2v4a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h5V3a3 3 0 0 1 6 0v4a.5.5 0 0 1-1 0V3a2 2 0 0 0-2-2'/>
    ...
    </svg>`}function Bo(i){return`<svg xmlns='http://www.w3.org/2000/svg' width='${i}' height='${i}' fill='currentColor' class='bi bi-exclamation-triangle' viewBox='0 0 16 16'>
...
Note: the video will be available in console as 'video'`,"");if(C===null)return;let p=document.createElement("video");p.src=C,p.classList.add("secret_video"),l.parentElement.appendChild(p),p.play(),window.video=p,this.seq&&(p.currentTime=parseFloat(window.prompt("Video offset to sync to midi, in seconds.","0")),p.play(),this.seq.currentTime=0),document.addEventListener("keydown",B=>{B.key===" "&&(p.paused?p.play():p.pause())});break;case fe.sustainPedal:this.renderer.showHoldPedal=!0,this.renderer.render(!1),this.keyboard.setHoldPedal(!0)}}),document.addEventListener("keyup",g=>{if(!g.ctrlKey)switch(g.key.toLowerCase()){case fe.sustainPedal:this.renderer.showHoldPedal=!1,this.renderer.render(!1),this.keyboard.setHoldPedal(!1);break;default:break}}),this.renderer.render(!1,!0)}doDLSCheck(){if(window.isLocalEdition!==!0){let e=this.soundFont.slice(8,12);le(new L(e),4).toLowerCase()==="dls "&&ae(this.localeManager.getLocaleString("locale.convertDls.title"),[{type:"text",textContent:this.localeManager.getLocaleString("locale.convertDls.message")},{type:"button",textContent:this.localeManager.getLocaleString("locale.yes"),onClick:o=>{ne(o.id),this.downloadDesfont()}},{type:"button",textContent:this.localeManager.getLocaleString("locale.no"),onClick:o=>{ne(o.id)}}],99999999)}}async reloadSf(e){await this.synth.soundfontManager.reloadManager(e),this.soundFont=e,setTimeout(()=>{this.doDLSCheck()},3e3)}play(e){if(this.synth){if(this.seq){this.seq.loadNewSongList(e),this.seq.play(!0);return}this.seq=new Wo(e,this.synth),this.seq.onError=t=>{document.getElementById("title").textContent=t},this.seqUI.connectSequencer(this.seq),this.musicModeUI.connectSequencer(this.seq),this.renderer.connectSequencer(this.seq),this.settingsUI.addSequencer(this.seq),this.synthUI.connectSequencer(this.seq),this.seq.play(!0)}}async downloadDLSRMI(){let e=await this.seq.getMIDI(),t=mt(this.soundFont),o=Ko(t.writeDLS(),e,t),n=new Blob([o.buffer],{type:"audio/rmid"});this.saveBlob(n,`${e.midiName}.rmi`)}downloadDesfont(){let e=mt(this.soundFont),t=e.write(),o=new Blob([t.buffer],{type:"audio/soundfont"});this.saveBlob(o,`${e.soundFontInfo.INAM}.sf2`)}};it.prototype.exportSong=Wr;it.prototype._exportAudioData=Ar;it.prototype._doExportAudioData=sr;it.prototype.exportMidi=rr;it.prototype._exportSoundfont=Kr;it.prototype._exportDLS=Xr;it.prototype._exportRMIDI=Zr;var Xa=44100,$a="GeneralUserGS.sf3",Qi=document.getElementById("title"),xt=document.getElementById("midi_file_input"),el=document.getElementById("sf_file_input"),$r=document.getElementById("demo_song"),nn=document.getElementById("export_button"),Yt=document.getElementsByClassName("loading")[0],Oe=document.getElementById("loading_message"),tl=await(await fetch("package.json")).json();window.SPESSASYNTH_VERSION=tl.version;var ol="spessasynth-db",Jt="soundFontStore";function rn(i){let e=indexedDB.open(ol,1);e.onsuccess=()=>{let t=e.result;i(t)},e.onupgradeneeded=t=>{t.target.result.createObjectStore(Jt,{keyPath:"id"})}}async function il(){return await new Promise(i=>{rn(e=>{let n=e.transaction([Jt],"readonly").objectStore(Jt).get("buffer");n.onerror=s=>{console.error("Database error"),console.error(s),i(void 0)},n.onsuccess=async()=>{let s=n.result;if(!s){i(void 0);return}i(s.data)}})})}function zt(i,e=!0){let t=Yt.getElementsByClassName("loading_icon")[0];t.innerHTML=i,t.style.animation=e?"none":""}async function ea(i){rn(e=>{let o=e.transaction([Jt],"readwrite").objectStore(Jt);try{let n=o.put({id:"buffer",data:i});n.onsuccess=()=>{x("SoundFont stored successfully")},n.onerror=s=>{console.error("Error saving soundfont",s)}}catch(n){Z("Failed saving soundfont:",n)}})}async function nl(i){let e=new li(i);try{let n=window.AudioContext||window.webkitAudioContext;window.audioContextMain=new n({sampleRate:Xa})}catch(n){throw zt(Bo(256)),Oe.textContent=e.getLocaleString("locale.synthInit.noWebAudio"),n}Oe.textContent=e.getLocaleString("locale.synthInit.loadingSoundfont");let t=await il(),o=!0;if(t===void 0){Z("Failed to load from db, fetching online instead"),o=!1;let n=document.getElementById("progress_bar"),s=e.getLocaleString("locale.synthInit.loadingBundledSoundfont");Oe.textContent=s,t=await sl(`soundfonts/${$a}`,A=>{Oe.textContent=`${s} ${A}%`}),n.style.width="0"}else x("Loaded the soundfont from the database succesfully");window.soundFontParser=t,o||(Oe.textContent=e.getLocaleString("locale.synthInit.savingSoundfont"),await ea(t)),window.audioContextMain.state!=="running"&&document.addEventListener("mousedown",()=>{window.audioContextMain.state!=="running"&&window.audioContextMain.resume().then()}),Oe.textContent=e.getLocaleString("locale.synthInit.startingSynthesizer"),window.manager=new it(audioContextMain,soundFontParser,e),window.manager.sfError=n=>{zt(Bo(256)),o?(Z("Invalid soundfont in the database. Resetting."),rn(s=>{let r=s.transaction([Jt],"readwrite").objectStore(Jt).delete("buffer");r.onsuccess=()=>{location.reload()}})):Qi.innerHTML=`Error parsing soundfont: <pre style='font-family: monospace; font-weight: bold'>${n}</pre>`,Oe.innerHTML=`Error parsing soundfont: <pre style='font-family: monospace; font-weight: bold'>${n}</pre>`},await manager.ready,xt.files[0]?await sn(xt.files):(xt.onclick=void 0,xt.onchange=()=>{xt.files[0]&&sn(xt.files).then()}),zt(Pi(256)),Oe.textContent=e.getLocaleString("locale.synthInit.done")}async function sl(i,e){let t=await fetch(i);if(!t.ok)throw Qi.innerText="Error downloading soundfont!",t;let o=t.headers.get("content-length"),n=await(await t.body).getReader(),s=!1,A=new Uint8Array(parseInt(o)),c=0;do{let r=await n.read();r.value&&(A.set(r.value,c),c+=r.value.length),s=r.done;let l=Math.round(c/o*100);e(l)}while(!s);return A.buffer}async function sn(i){$r.style.display="none";let e;i[0].name.length>20?e=i[0].name.substring(0,21)+"...":e=i[0].name,i.length>1&&(e+=` and ${i.length-1} others`),document.getElementById("file_upload").innerText=e,document.getElementById("file_upload").title=i[0].name;let t=[];for(let o of i)t.push({binary:await o.arrayBuffer(),altName:o.name});manager.synth.setLogLevel(!1,!1,!1,!1),manager.seq?manager.seq.loadNewSongList(t):manager.play(t),nn.style.display="flex",nn.onclick=window.manager.exportSong.bind(window.manager)}function Al(i){localStorage.setItem("spessasynth-settings",JSON.stringify(i)),x("saved as",i)}window.saveSettings=Al;var ko=JSON.parse(localStorage.getItem("spessasynth-settings"));ko!==null&&(window.savedSettings=new Promise(i=>{i(ko)}));var An;ko&&ko.interface&&ko.interface.language?An=(await savedSettings).interface.language||navigator.language.split("-")[0].toLowerCase():An=navigator.language.split("-")[0].toLowerCase();xt.value="";xt.focus();nn.style.display="none";document.getElementById("sf_upload").style.display="none";document.getElementById("file_upload").style.display="none";async function rl(i){Qi.textContent=window.manager.localeManager.getLocaleString("locale.synthInit.genericLoading");let e=await fetch("https://spessasus.github.io/spessasynth-demo-songs/demo_songs/"+i);e.name=i,await sn([e])}nl(An).then(()=>{document.getElementById("sf_upload").style.display="flex",document.getElementById("file_upload").style.display="flex",Yt.classList.add("done"),document.documentElement.classList.add("no_scroll"),document.body.classList.add("no_scroll"),setTimeout(()=>{Yt.style.display="none",document.body.classList.remove("no_scroll"),document.documentElement.classList.remove("no_scroll"),_e&&window.chrome&&ae(window.manager.localeManager.getLocaleString("locale.warnings.warning"),[{type:"text",textContent:window.manager.localeManager.getLocaleString("locale.warnings.chromeMobile")}],7)},1e3),el.onchange=i=>{if(!i.target.files[0])return;let e=i.target.files[0];window.manager.seq&&window.manager.seq.pause(),document.getElementById("sf_upload").firstElementChild.innerText=e.name,Yt.style.display="",setTimeout(async()=>{Yt.classList.remove("done"),zt(cs(256),!1),Oe.textContent=window.manager.localeManager.getLocaleString("locale.synthInit.loadingSoundfont");let t=performance.now()/1e3,o;try{o=await e.arrayBuffer(),window.soundFontParser=o}catch(s){throw Oe.textContent=window.manager.localeManager.getLocaleString("locale.warnings.outOfMemory"),zt(Bo(256)),ae(manager.localeManager.getLocaleString("locale.warnings.warning"),[{type:"text",textContent:window.manager.localeManager.getLocaleString("locale.warnings.outOfMemory")}]),s}window.manager.sfError=s=>{Oe.innerHTML=`Error parsing soundfont: <pre style='font-family: monospace; font-weight: bold'>${s}</pre>`,zt(Bo(256)),console.error(s)},Oe.textContent=window.manager.localeManager.getLocaleString("locale.synthInit.startingSynthesizer"),await window.manager.reloadSf(o),window.manager.seq&&(window.manager.seq.currentTime-=.1),Oe.textContent=window.manager.localeManager.getLocaleString("locale.synthInit.savingSoundfont"),await ea(o);let n=performance.now()/1e3-t;await new Promise(s=>setTimeout(s,1e3-n)),zt(Pi(256)),Oe.textContent=window.manager.localeManager.getLocaleString("locale.synthInit.done"),Yt.classList.add("done"),document.documentElement.classList.add("no_scroll"),document.body.classList.add("no_scroll"),setTimeout(()=>{Yt.style.display="none",document.body.classList.remove("no_scroll"),document.documentElement.classList.remove("no_scroll")},1e3)},75)},$r.onclick=async()=>{let i=[{type:"button",textContent:"Bundled SoundFont Credits",onClick:()=>{window.open("https://schristiancollins.com/generaluser.php")}}];Qi.textContent=window.manager.localeManager.getLocaleString("locale.synthInit.genericLoading");let e=await(await fetch("https://spessasus.github.io/spessasynth-demo-songs/demo_song_list.json")).text(),t=JSON.parse(e);for(let o of t)i.push({type:"button",textContent:o.name,onClick:n=>{ne(n.id),ae(window.manager.localeManager.getLocaleString("locale.credits"),[{type:"text",textContent:o.credits.replace(`
`,`\r
\r
