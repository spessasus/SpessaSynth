...
`}},Ri=960,Li=Oe.concave;function $e(o,e,t,i,n){return o<<10|e<<9|t<<8|i<<7|n}var aa=[new Z({srcEnum:$e(Li,0,1,0,de.noteOnVelocity),dest:I.initialAttenuation,amt:Ri,secSrcEnum:0,transform:0}),new Z({srcEnum:129,dest:I.vibLfoToPitch,amt:50,secSrcEnum:0,transform:0}),new Z({srcEnum:$e(Li,0,1,1,R.mainVolume),dest:I.initialAttenuation,amt:Ri,secSrcEnum:0,transform:0}),new Z({srcEnum:13,dest:I.vibLfoToPitch,amt:50,secSrcEnum:0,transform:0}),new Z({srcEnum:526,dest:I.fineTune,amt:12700,secSrcEnum:16,transform:0}),new Z({srcEnum:650,dest:I.pan,amt:500,secSrcEnum:0,transform:0}),new Z({srcEnum:$e(Li,0,1,1,R.expressionController),dest:I.initialAttenuation,amt:Ri,secSrcEnum:0,transform:0}),new Z({srcEnum:219,dest:I.reverbEffectsSend,amt:200,secSrcEnum:0,transform:0}),new Z({srcEnum:221,dest:I.chorusEffectsSend,amt:200,secSrcEnum:0,transform:0})],la=[new Z({srcEnum:$e(Oe.linear,0,0,0,de.polyPressure),dest:I.vibLfoToPitch,amt:50,secSrcEnum:0,transform:0}),new Z({srcEnum:$e(Oe.linear,0,0,1,R.tremoloDepth),dest:I.modLfoToVolume,amt:24,secSrcEnum:0,transform:0}),new Z({srcEnum:$e(Oe.linear,1,0,1,R.releaseTime),dest:I.releaseVolEnv,amt:1200,secSrcEnum:0,transform:0}),new Z({srcEnum:$e(Oe.linear,1,0,1,R.brightness),dest:I.initialFilterFc,amt:6e3,secSrcEnum:0,transform:0}),new Z({srcEnum:$e(Oe.linear,1,0,1,R.timbreHarmonicContent),dest:I.initialFilterQ,amt:250,secSrcEnum:0,transform:0})],Lo=aa.concat(la);var Ft=128,Mn=147,ca=new Int16Array(Mn).fill(0),ve=(o,e)=>ca[o]=e<<7;ve(R.mainVolume,100);ve(R.balance,64);ve(R.expressionController,127);ve(R.pan,64);ve(R.timbreHarmonicContent,64);ve(R.releaseTime,64);ve(R.attackTime,64);ve(R.brightness,64);ve(R.soundController6,64);ve(R.soundController7,64);ve(R.soundController8,64);ve(R.soundController9,64);ve(R.generalPurposeController6,64);ve(R.generalPurposeController8,64);ve(R.portamentoControl,64);ve(Ft+de.pitchWheel,64);ve(Ft+de.pitchWheelRange,2);var Go={channelTuning:0,channelTransposeFine:1,modulationMultiplier:2,masterTuning:3,channelTuningSemitones:4},Fn=Object.keys(Go).length,ga=new Float32Array(Fn);ga[Go.modulationMultiplier]=1;var Rn={velocityOverride:128};var To=class{velocity=-1;patch={bank:-1,program:-1};constructor(e=-1,t=-1,i=-1){this.velocity=e,this.patch={bank:t,program:i}}},No={addMapping:0,deleteMapping:1,clearMappings:2};var Uo=class{constructor(e){this.synth=e,this._keyModifiers=[]}_sendToWorklet(e,t){this.synth.post({messageType:ae.keyModifierManager,messageData:[e,t]})}addModifier(e,t,i){let n=i?.velocity??-1,s=i?.patch?.program??-1,A=i?.patch?.bank??-1,g=new To(n,A,s);this._keyModifiers[e]===void 0&&(this._keyModifiers[e]=[]),this._keyModifiers[e][t]=g,this._sendToWorklet(No.addMapping,[e,t,g])}getModifier(e,t){return this._keyModifiers?.[e]?.[t]}deleteModifier(e,t){this._sendToWorklet(No.deleteMapping,[e,t]),this._keyModifiers[e]?.[t]!==void 0&&(this._keyModifiers[e][t]=void 0)}clearModifiers(){this._sendToWorklet(No.clearMappings,void 0),this._keyModifiers=[]}};var da="spessasynth-worklet-system",Gi=350,Ye=9,ha=16;var Kt=class{constructor(e,t,i=!0,n=void 0,s=xn){v("%cInitializing SpessaSynth synthesizer...",f.info),this.context=e.context,this.targetNode=e;let A=n?.oneOutput===!0;this.eventHandler=new Fo,this._voiceCap=Gi,this._destroyed=!1,this._outputsAmount=ha,this.channelsAmount=this._outputsAmount,this.resolveWhenReady=void 0,this.isReady=new Promise(l=>this.resolveWhenReady=l),this.channelProperties=[];for(let l=0;l<this.channelsAmount;l++)this.addNewChannel(!1);this.channelProperties[Ye].isDrum=!0,this._voicesAmount=0,this._highPerformanceMode=!1;let g=Array(this._outputsAmount+2).fill(2),r=this._outputsAmount+2;A&&(r=1,g=[32]),n?.snapshot?.effectsConfig!==void 0?(this.effectsConfig=n.snapshot.effectsConfig,delete n.snapshot.effectsConfig):this.effectsConfig=s;try{let l=s?.audioNodeCreators?.worklet;l||(l=(u,d,a)=>new AudioWorkletNode(u,d,a)),this.worklet=l(this.context,da,{outputChannelCount:g,numberOfOutputs:r,processorOptions:{midiChannels:this._outputsAmount,soundfont:t,enableEventSystem:i,startRenderingData:n}})}catch(l){throw console.error(l),new Error("Could not create the audioWorklet. Did you forget to addModule()?")}if(this.worklet.port.onmessage=l=>this.handleMessage(l.data),this.soundfontManager=new Ro(this),this.keyModifierManager=new Uo(this),this._snapshotCallback=void 0,this.sequencerCallbackFunction=void 0,A)this.worklet.connect(e,0);else{let l=this.effectsConfig?.reverbEnabled??!0,u=this.effectsConfig?.chorusEnabled??!0;l&&(this.reverbProcessor=vn(this.context,this.effectsConfig.reverbImpulseResponse),this.reverbProcessor.connect(e),this.worklet.connect(this.reverbProcessor,0)),u&&(this.chorusProcessor=new Ao(e,this.effectsConfig.chorusConfig),this.worklet.connect(this.chorusProcessor.input,1));for(let d=2;d<this.channelsAmount+2;d++)this.worklet.connect(e,d)}this.eventHandler.addEvent("newchannel","synth-new-channel",()=>{this.channelsAmount++})}get voiceCap(){return this._voiceCap}set voiceCap(e){this._setMasterParam(ro.voicesCap,e),this._voiceCap=e}get highPerformanceMode(){return this._highPerformanceMode}set highPerformanceMode(e){this._highPerformanceMode=e}get currentTime(){return this.context.currentTime}get voicesAmount(){return this._voicesAmount}setLogLevel(e,t,i,n){this.post({channelNumber:Me,messageType:ae.setLogLevel,messageData:[e,t,i,n]})}_setMasterParam(e,t){this.post({channelNumber:Me,messageType:ae.setMasterParameter,messageData:[e,t]})}setInterpolationType(e){this._setMasterParam(ro.interpolationType,e)}handleMessage(e){let t=e.messageData;switch(e.messageType){case Mt.channelProperties:this.channelProperties=t,this._voicesAmount=this.channelProperties.reduce((i,n)=>i+n.voicesAmount,0);break;case Mt.eventCall:this.eventHandler.callEvent(t.eventName,t.eventData);break;case Mt.sequencerSpecific:this.sequencerCallbackFunction&&this.sequencerCallbackFunction(t.messageType,t.messageData);break;case Mt.synthesizerSnapshot:this._snapshotCallback&&this._snapshotCallback(t);break;case Mt.ready:this.resolveWhenReady();break;case Mt.soundfontError:W(new Error(t)),this.eventHandler.callEvent("soundfonterror",t);break}}async getSynthesizerSnapshot(){return new Promise(e=>{this._snapshotCallback=t=>{this._snapshotCallback=void 0,t.effectsConfig=this.effectsConfig,e(t)},this.post({messageType:ae.requestSynthesizerSnapshot,messageData:void 0,channelNumber:Me})})}addNewChannel(e=!0){this.channelProperties.push({voicesAmount:0,pitchBend:0,pitchBendRangeSemitones:0,isMuted:!1,isDrum:!1}),e&&this.post({channelNumber:0,messageType:ae.addNewChannel,messageData:null})}setVibrato(e,t){this.post({channelNumber:e,messageType:ae.setChannelVibrato,messageData:t})}connectIndividualOutputs(e){if(e.length!==this._outputsAmount)throw new Error(`input nodes amount differs from the system's outputs amount!
...
</svg>`}function uo(o){return`<svg xmlns='http://www.w3.org/2000/svg' width='${o}' height='${o}' fill='currentColor' class='bi bi-volume-up-fill' viewBox='0 0 16 16'>
...
</svg>`}function mo(o){return`<svg xmlns='http://www.w3.org/2000/svg' width='${o*.8}' height='${o*.8}' fill='currentColor' class='bi bi-lock-fill' viewBox='0 0 16 16'>
  ...
  <path d='M11 1a2 2 0 0 0-2 2v4a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h5V3a3 3 0 0 1 6 0v4a.5.5 0 0 1-1 0V3a2 2 0 0 0-2-2'/>
    ...
    </svg>`}function Co(o){return`<svg xmlns="http://www.w3.org/2000/svg" width="${o}" height="${o}" fill="currentColor" class="bi bi-exclamation-triangle" viewBox="0 0 16 16">
...
Note: the video will be available in console as 'video'`,"");if(m===null)return;let B=document.createElement("video");B.src=m,B.classList.add("secret_video"),l.parentElement.appendChild(B),B.play(),window.video=B,this.seq&&(B.currentTime=parseFloat(window.prompt("Video offset to sync to midi, in seconds.","0")),B.play(),this.seq.currentTime=0),document.addEventListener("keydown",E=>{E.key===" "&&(B.paused?B.play():B.pause())});break}}),this.renderer.render(!1,!0)}doDLSCheck(){if(window.isLocalEdition!==!0){let e=this.soundFont.slice(8,12);le(new F(e),4).toLowerCase()==="dls "&&Ae(this.localeManager.getLocaleString("locale.convertDls.title"),[{type:"text",textContent:this.localeManager.getLocaleString("locale.convertDls.message")},{type:"button",textContent:this.localeManager.getLocaleString("locale.yes"),onClick:i=>{oe(i.id),this.downloadDesfont()}},{type:"button",textContent:this.localeManager.getLocaleString("locale.no"),onClick:i=>{oe(i.id)}}],99999999)}}async reloadSf(e){await this.synth.soundfontManager.reloadManager(e),this.soundFont=e,setTimeout(()=>{this.doDLSCheck()},3e3)}play(e){if(this.synth){if(this.seq){this.seq.loadNewSongList(e),this.seq.play(!0);return}this.seq=new Jo(e,this.synth),this.seq.onError=t=>{document.getElementById("title").textContent=t},this.seqUI.connectSequencer(this.seq),this.playerUI.connectSequencer(this.seq),this.renderer.connectSequencer(this.seq),this.settingsUI.addSequencer(this.seq),this.seq.play(!0)}}async downloadDLSRMI(){let e=await this.seq.getMIDI(),t=It(this.soundFont),i=Vo(t.writeDLS(),e,t),n=new Blob([i.buffer],{type:"audio/rmid"});this.saveBlob(n,`${e.midiName}.rmi`)}downloadDesfont(){let e=It(this.soundFont),t=e.write(),i=new Blob([t.buffer],{type:"audio/soundfont"});this.saveBlob(i,`${e.soundFontInfo.INAM}.sf2`)}};ot.prototype.exportSong=Or;ot.prototype._exportAudioData=er;ot.prototype._doExportAudioData=$A;ot.prototype.exportMidi=tr;ot.prototype._exportSoundfont=Pr;ot.prototype._exportDLS=Jr;ot.prototype._exportRMIDI=Yr;var Ya=44100,Va="GeneralUserGS.sf3",Ei=document.getElementById("title"),Dt=document.getElementById("midi_file_input"),Ja=document.getElementById("sf_file_input"),Kr=document.getElementById("demo_song"),on=document.getElementById("export_button"),_t=document.getElementsByClassName("loading")[0],He=document.getElementById("loading_message"),Ka=await(await fetch("package.json")).json();window.SPESSASYNTH_VERSION=Ka.version;var za="spessasynth-db",Pt="soundFontStore";function An(o){let e=indexedDB.open(za,1);e.onsuccess=()=>{let t=e.result;o(t)},e.onupgradeneeded=t=>{t.target.result.createObjectStore(Pt,{keyPath:"id"})}}async function Wa(){return await new Promise(o=>{An(e=>{let n=e.transaction([Pt],"readonly").objectStore(Pt).get("buffer");n.onerror=s=>{console.error("Database error"),console.error(s),o(void 0)},n.onsuccess=async()=>{let s=n.result;if(!s){o(void 0);return}o(s.data)}})})}function Ht(o,e=!0){let t=_t.getElementsByClassName("loading_icon")[0];t.innerHTML=o,t.style.animation=e?"none":""}async function zr(o){An(e=>{let i=e.transaction([Pt],"readwrite").objectStore(Pt);try{let n=i.put({id:"buffer",data:o});n.onsuccess=()=>{v("SoundFont stored successfully")},n.onerror=s=>{console.error("Error saving soundfont",s)}}catch(n){W("Failed saving soundfont:",n)}})}async function Za(o){let e=new Ai(o);try{let n=window.AudioContext||window.webkitAudioContext;window.audioContextMain=new n({sampleRate:Ya})}catch(n){throw Ht(Co(256)),He.textContent=e.getLocaleString("locale.synthInit.noWebAudio"),n}He.textContent=e.getLocaleString("locale.synthInit.loadingSoundfont");let t=await Wa(),i=!0;if(t===void 0){W("Failed to load from db, fetching online instead"),i=!1;let n=document.getElementById("progress_bar"),s=e.getLocaleString("locale.synthInit.loadingBundledSoundfont");He.textContent=s,t=await ja(`soundfonts/${Va}`,A=>{He.textContent=`${s} ${A}%`}),n.style.width="0"}else v("Loaded the soundfont from the database succesfully");window.soundFontParser=t,i||(He.textContent=e.getLocaleString("locale.synthInit.savingSoundfont"),await zr(t)),window.audioContextMain.state!=="running"&&document.addEventListener("mousedown",()=>{window.audioContextMain.state!=="running"&&window.audioContextMain.resume().then()}),He.textContent=e.getLocaleString("locale.synthInit.startingSynthesizer"),window.manager=new ot(audioContextMain,soundFontParser,e),window.manager.sfError=n=>{Ht(Co(256)),i?(W("Invalid soundfont in the database. Resetting."),An(s=>{let r=s.transaction([Pt],"readwrite").objectStore(Pt).delete("buffer");r.onsuccess=()=>{location.reload()}})):Ei.innerHTML=`Error parsing soundfont: <pre style='font-family: monospace; font-weight: bold'>${n}</pre>`,He.innerHTML=`Error parsing soundfont: <pre style='font-family: monospace; font-weight: bold'>${n}</pre>`},await manager.ready,Dt.files[0]?await nn(Dt.files):(Dt.onclick=void 0,Dt.onchange=()=>{Dt.files[0]&&nn(Dt.files).then()}),Ht(_i(256)),He.textContent=e.getLocaleString("locale.synthInit.done")}async function ja(o,e){let t=await fetch(o);if(!t.ok)throw Ei.innerText="Error downloading soundfont!",t;let i=t.headers.get("content-length"),n=await(await t.body).getReader(),s=!1,A=new Uint8Array(parseInt(i)),g=0;do{let r=await n.read();r.value&&(A.set(r.value,g),g+=r.value.length),s=r.done;let l=Math.round(g/i*100);e(l)}while(!s);return A.buffer}async function nn(o){Kr.style.display="none";let e;o[0].name.length>20?e=o[0].name.substring(0,21)+"...":e=o[0].name,o.length>1&&(e+=` and ${o.length-1} others`),document.getElementById("file_upload").innerText=e,document.getElementById("file_upload").title=o[0].name;let t=[];for(let i of o)t.push({binary:await i.arrayBuffer(),altName:i.name});manager.synth.setLogLevel(!1,!1,!1,!1),manager.seq?manager.seq.loadNewSongList(t):manager.play(t),on.style.display="flex",on.onclick=window.manager.exportSong.bind(window.manager)}function Xa(o){localStorage.setItem("spessasynth-settings",JSON.stringify(o)),v("saved as",o)}window.saveSettings=Xa;var Qo=JSON.parse(localStorage.getItem("spessasynth-settings"));Qo!==null&&(window.savedSettings=new Promise(o=>{o(Qo)}));var sn;Qo&&Qo.interface&&Qo.interface.language?sn=(await savedSettings).interface.language||navigator.language.split("-")[0].toLowerCase():sn=navigator.language.split("-")[0].toLowerCase();Dt.value="";Dt.focus();on.style.display="none";document.getElementById("sf_upload").style.display="none";document.getElementById("file_upload").style.display="none";async function $a(o){Ei.textContent=window.manager.localeManager.getLocaleString("locale.synthInit.genericLoading");let e=await fetch("https://spessasus.github.io/spessasynth-demo-songs/demo_songs/"+o);e.name=o,await nn([e])}Za(sn).then(()=>{document.getElementById("sf_upload").style.display="flex",document.getElementById("file_upload").style.display="flex",_t.classList.add("done"),document.documentElement.classList.add("no_scroll"),document.body.classList.add("no_scroll"),setTimeout(()=>{_t.style.display="none",document.body.classList.remove("no_scroll"),document.documentElement.classList.remove("no_scroll"),Ue&&window.chrome&&Ae(window.manager.localeManager.getLocaleString("locale.warnings.warning"),[{type:"text",textContent:window.manager.localeManager.getLocaleString("locale.warnings.chromeMobile")}],7)},1e3),Ja.onchange=o=>{if(!o.target.files[0])return;let e=o.target.files[0];window.manager.seq&&window.manager.seq.pause(),document.getElementById("sf_upload").firstElementChild.innerText=e.name,_t.style.display="",setTimeout(async()=>{_t.classList.remove("done"),Ht(ls(256),!1),He.textContent=window.manager.localeManager.getLocaleString("locale.synthInit.loadingSoundfont");let t=performance.now()/1e3,i;try{i=await e.arrayBuffer(),window.soundFontParser=i}catch(s){throw He.textContent=window.manager.localeManager.getLocaleString("locale.warnings.outOfMemory"),Ht(Co(256)),Ae(manager.localeManager.getLocaleString("locale.warnings.warning"),[{type:"text",textContent:window.manager.localeManager.getLocaleString("locale.warnings.outOfMemory")}]),s}window.manager.sfError=s=>{He.innerHTML=`Error parsing soundfont: <pre style='font-family: monospace; font-weight: bold'>${s}</pre>`,Ht(Co(256)),console.error(s)},He.textContent=window.manager.localeManager.getLocaleString("locale.synthInit.startingSynthesizer"),await window.manager.reloadSf(i),window.manager.seq&&(window.manager.seq.currentTime-=.1),He.textContent=window.manager.localeManager.getLocaleString("locale.synthInit.savingSoundfont"),await zr(i);let n=performance.now()/1e3-t;await new Promise(s=>setTimeout(s,1e3-n)),Ht(_i(256)),He.textContent=window.manager.localeManager.getLocaleString("locale.synthInit.done"),_t.classList.add("done"),document.documentElement.classList.add("no_scroll"),document.body.classList.add("no_scroll"),setTimeout(()=>{_t.style.display="none",document.body.classList.remove("no_scroll"),document.documentElement.classList.remove("no_scroll")},1e3)},75)},Kr.onclick=async()=>{let o=[{type:"button",textContent:"Bundled SoundFont Credits",onClick:()=>{window.open("https://schristiancollins.com/generaluser.php")}}];Ei.textContent=window.manager.localeManager.getLocaleString("locale.synthInit.genericLoading");let e=await(await fetch("https://spessasus.github.io/spessasynth-demo-songs/demo_song_list.json")).text(),t=JSON.parse(e);for(let i of t)o.push({type:"button",textContent:i.name,onClick:n=>{oe(n.id),Ae(window.manager.localeManager.getLocaleString("locale.credits"),[{type:"text",textContent:i.credits.replace(`
`,`\r
\r
`),attributes:{style:"white-space: pre-line;"}},{type:"button",textContent:"Ok",onClick:s=>{oe(s.id)}}],999999,!0,void 0,void 0,async()=>{await $a(i.fileName)})}});Ae(window.manager.localeManager.getLocaleString("locale.demoSongButton"),o,999999,!0,void 0)}});
