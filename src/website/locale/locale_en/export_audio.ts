export const exportAudio = {
    ...
    formats: {
        ...
        formats: {
            wav: {
                button: {
                    title: "WAV audio (.wav)",
                    description:
                        "Export the song with modifications as a .wav audio file"
                },
                options: {
            ...
            soundfont: {
                ...
                options: {
                    ...
                    trim: {
                        title: "Trim",
                        description:
                            "Export the soundfont trimmed to only use instruments and samples that the MIDI file uses"
                    },
                    compress: {
                        title: "Compress",
                        description:
                    ...
                    quality: {
                        ...
                        description:
                            "The quality of compression. Higher is better"
                    }
                },
            ...
            dls: {
                ...
                warning: {
                    ...
                    message:
                        "DLS export is limited and may produce broken files with large and complex SoundFonts.",
                    details: "More info",
            ...
            rmidi: {
                ...
                options: {
                    ...
                    bankOffset: {
                        title: "Bank offset",
                        description:
                            "The bank offset of the file. Value of 0 is recommended. Only change if you know what you're doing."
                    },
                    adjust: {
                        title: "Adjust MIDI",
                        description:
                            "Adjusts the MIDI file to the SoundFont. Leave this on unless you know what you're doing."
                    }
                }
            }
        },
        metadata: {
            ...
            software: {
                title: "Software:",
                description: "The software used to write the song"
            }
        }
    }
};
