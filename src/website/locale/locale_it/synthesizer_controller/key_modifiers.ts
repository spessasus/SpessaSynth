export const keyModifiers = {
    ...
    modifyKey: {
        ...
        gain: {
            title: "Guadagno",
            description:
                "Guadagno lineare per questa voce. Imposta a 1 per non modificare."
        },
        preset: {
    ...
    removeModification: {
        ...
        description:
            "Rimuovi la modifica da un singolo tasto su un determinato canale",
    ...
    resetModifications: {
        ...
        description:
            "Cancella e reimposta tutte le modifiche ai tasti da tutti i canali",
