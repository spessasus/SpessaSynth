export const midiSettingsLocale = {
    ...
    reminder: {
        //"Note that you need to RESTART YOUR BROWSER after connecting a new MIDI device for it to show up here.",
        title: "注意: 新しく接続したMIDIデバイスをここに表示するためには、ブラウザを再起動する必要があります。",
        description:
