export const effectsConfig = {
    ...
    misc: {
        title: "その他の設定",
        //"Configure miscellaneous settings of the synthesizer.",
        description: "シンセサイザーのその他の設定を構成します。",
        ...
        voiceCap: {
            title: "最大ボイス数",
            description: "最大ボイス数: 一度に再生できるボイスの最大数"
        },
        ...
        customVibrato: {
            title: "カスタムビブラート",
            description:
                "カスタムビブラート: NRPNを使ったカスタムビブラートを有効にします"
        }
    },

    reverb: {
        title: "リバーブ設定",
        //"Configure how the reverb effect sounds.",
        description: "リバーブの設定: リバーブエフェクトの音を構成します。",

        level: {
            title: "レベル: ",
            //"Level: This parameter sets the amount of the effect."
            description: "レベル: リバーブエフェクトの量を設定します。"
        },
