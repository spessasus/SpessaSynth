export const channelControllerLocale = {
    voiceMeter: {
        title: "ボイス: ",
        description: "ボイス: 現在チャンネル{0}で再生中の音の数"
    },

    pitchBendMeter: {
        title: "ピッチベンド: ",
        description: "ピッチベンド: チャンネル{0}に適用された現在のピッチベンド"
    },
    ...
    groupSelector: {
        //"Select the group of MIDI Controllers to manipulate",
        description: "操作するMIDIコントローラーのグループを選択",
        effects: "エフェクト",
