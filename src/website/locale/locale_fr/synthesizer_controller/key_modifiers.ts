export const keyModifiers = {
    ...
    removeModification: {
        ...
        description:
            "Enlever un modificateur s'appliquant à une note pour un canal donné",
    ...
    resetModifications: {
        ...
        description:
            "Enlever tous les modificateurs de notes pour tous les canaux",

        confirmation: {
            title: "Confirmation",
            description:
                "Êtes-vous sûr(e) de bien vouloir supprimer tous les modificateurs ?"
        }
    }
};
