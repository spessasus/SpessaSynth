var ns=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(A,t)=>(typeof require<"u"?require:A)[t]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var H=class extends Uint8Array{constructor(A){super(A),this.currentIndex=0}currentIndex};function me(e){let A=e.reduce((n,o)=>n+o.length,0),t=new H(A),s=0;for(let n of e)t.set(n,s),s+=n.length;return t}function Qt(e){e=Math.floor(e);let A=Math.floor(e/60),t=Math.round(e-A*60);return{minutes:A,seconds:t,time:`${A.toString().padStart(2,"0")}:${t.toString().padStart(2,"0")}`}}function os(e){return e.trim().replaceAll(".mid","").replaceAll(".rmi","").replaceAll("_"," ")}function hA(e){let A="";for(let t=0;t<e.length;t++){let s=e[t].toString(16).padStart(2,"0").toUpperCase();A+=s,A+=" "}return A}var I={warn:"color: orange;",unrecognized:"color: red;",info:"color: aqua;",recognized:"color: lime",value:"color: yellow; background-color: black;"};var oe=class{constructor(A,t,s){this.ticks=A,this.messageStatusByte=t,this.messageData=s}};function rs(e){let A=e&240,t=e&15,s=t;switch(A){case 128:case 144:case 160:case 176:case 192:case 208:case 224:break;case 240:switch(t){case 0:s=-3;break;case 1:case 2:case 3:case 4:case 5:case 6:case 7:case 8:case 9:case 10:case 11:case 12:case 13:case 14:s=-1;break;case 15:s=-2;break}break;default:s=-1}return s}var w={noteOff:128,noteOn:144,polyPressure:160,controllerChange:176,programChange:192,channelPressure:208,pitchBend:224,systemExclusive:240,timecode:241,songPosition:242,songSelect:243,tuneRequest:246,clock:248,start:250,continue:251,stop:252,activeSensing:254,reset:255,sequenceNumber:0,text:1,copyright:2,trackName:3,instrumentName:4,lyric:5,marker:6,cuePoint:7,midiChannelPrefix:32,midiPort:33,endOfTrack:47,setTempo:81,smpteOffset:84,timeSignature:88,keySignature:89,sequenceSpecific:127};function pe(e){let A=e&240,t=e&15,s=-1,n=e;return A>=128&&A<=224&&(s=t,n=A),{status:n,channel:s}}var S={bankSelect:0,modulationWheel:1,breathController:2,footController:4,portamentoTime:5,dataEntryMsb:6,mainVolume:7,balance:8,pan:10,expressionController:11,effectControl1:12,effectControl2:13,generalPurposeController1:16,generalPurposeController2:17,generalPurposeController3:18,generalPurposeController4:19,lsbForControl0BankSelect:32,lsbForControl1ModulationWheel:33,lsbForControl2BreathController:34,lsbForControl4FootController:36,lsbForControl5PortamentoTime:37,lsbForControl6DataEntry:38,lsbForControl7MainVolume:39,lsbForControl8Balance:40,lsbForControl10Pan:42,lsbForControl11ExpressionController:43,lsbForControl12EffectControl1:44,lsbForControl13EffectControl2:45,sustainPedal:64,portamentoOnOff:65,sostenutoPedal:66,softPedal:67,legatoFootswitch:68,hold2Pedal:69,soundVariation:70,timbreHarmonicContent:71,releaseTime:72,attackTime:73,brightness:74,soundController6:75,soundController7:76,soundController8:77,soundController9:78,soundController10:79,generalPurposeController5:80,generalPurposeController6:81,generalPurposeController7:82,generalPurposeController8:83,portamentoControl:84,effects1Depth:91,effects2Depth:92,effects3Depth:93,effects4Depth:94,effects5Depth:95,dataIncrement:96,dataDecrement:97,NRPNLsb:98,NRPNMsb:99,RPNLsb:100,RPNMsb:101,allSoundOff:120,resetAllControllers:121,localControlOnOff:122,allNotesOff:123,omniModeOff:124,omniModeOn:125,monoModeOn:126,polyModeOn:127},is={8:2,9:2,10:2,11:2,12:1,13:1,14:2};var AA={noteOff:0,noteOn:1,ccChange:2,programChange:3,channelPressure:4,polyPressure:5,killNote:6,ccReset:7,setChannelVibrato:8,soundFontManager:9,stopAll:10,killNotes:11,muteChannel:12,addNewChannel:13,customcCcChange:14,debugMessage:15,systemExclusive:16,setMasterParameter:17,setDrums:18,pitchWheel:19,transpose:20,highPerformanceMode:21,lockController:22,sequencerSpecific:23,requestSynthesizerSnapshot:24,setLogLevel:25},Se={mainVolume:0,masterPan:1,voicesCap:2},bA=-1,mA={channelProperties:0,eventCall:1,reportedCurrentTime:2,sequencerSpecific:3,synthesizerSnapshot:4,ready:5,soundfontError:6};var Is=!0,as=!0,Te=!0,gs=!0;function Cs(e,A,t,s){Is=e,as=A,Te=t,gs=s}function p(...e){Is&&console.info(...e)}function Y(...e){as&&console.warn(...e)}function Es(...e){gs&&console.table(...e)}function Ae(...e){Te&&console.group(...e)}function yA(...e){Te&&console.groupCollapsed(...e)}function X(){Te&&console.groupEnd()}var re={reloadSoundFont:0,addNewSoundFont:2,deleteSoundFont:3,rearrangeSoundFonts:4};var Bs="spessasynth-worklet-system",hs=450,xA=9,He=16,Ye="gs";var MA={loadNewSongList:0,pause:1,stop:2,play:3,setTime:4,changeMIDIMessageSending:5,setPlaybackRate:6,setLoop:7,changeSong:8,getMIDI:9,setSkipToFirstNote:10},DA={midiEvent:0,songChange:1,textEvent:2,timeChange:3,pause:4,getMIDI:5,midiError:6};function WA(e,A){let t=0;for(let s=8*(A-1);s>=0;s-=8)t|=e[e.currentIndex++]<<s;return t>>>0}function Qs(e,A){if(this.ignoreEvents)return;if(this.sendMIDIMessages&&e.messageStatusByte>=128){this.sendMIDIMessage([e.messageStatusByte,...e.messageData]);return}let t=pe(e.messageStatusByte),s=this.midiPortChannelOffsets[this.midiPorts[A]]||0;switch(t.channel+=s,t.status){case w.noteOn:let n=e.messageData[1];if(n>0)this.synth.noteOn(t.channel,e.messageData[0],n),this.playingNotes.push({midiNote:e.messageData[0],channel:t.channel,velocity:n});else{this.synth.noteOff(t.channel,e.messageData[0]);let E=this.playingNotes.findIndex(C=>C.midiNote===e.messageData[0]&&C.channel===t.channel);E!==-1&&this.playingNotes.splice(E,1)}break;case w.noteOff:this.synth.noteOff(t.channel,e.messageData[0]);let o=this.playingNotes.findIndex(E=>E.midiNote===e.messageData[0]&&E.channel===t.channel);o!==-1&&this.playingNotes.splice(o,1);break;case w.pitchBend:this.synth.pitchWheel(t.channel,e.messageData[1],e.messageData[0]);break;case w.controllerChange:this.synth.controllerChange(t.channel,e.messageData[0],e.messageData[1]);break;case w.programChange:this.synth.programChange(t.channel,e.messageData[0]);break;case w.polyPressure:this.synth.polyPressure(t.channel,e.messageData[0],e.messageData[1]);break;case w.channelPressure:this.synth.channelPressure(t.channel,e.messageData[0]);break;case w.systemExclusive:this.synth.systemExclusive(e.messageData,s);break;case w.setTempo:this.oneTickToSeconds=60/(Do(e)*this.midiData.timeDivision),this.oneTickToSeconds===0&&(this.oneTickToSeconds=60/(120*this.midiData.timeDivision),Y("invalid tempo! falling back to 120 BPM"));break;case w.timeSignature:case w.endOfTrack:case w.midiChannelPrefix:case w.songPosition:case w.activeSensing:case w.keySignature:break;case w.text:case w.lyric:case w.copyright:case w.trackName:case w.marker:case w.cuePoint:case w.instrumentName:this.post(DA.textEvent,[e.messageData,t.status]);break;case w.midiPort:this.assignMIDIPort(A,e.messageData[0]);break;case w.reset:this.synth.stopAllChannels(),this.synth.resetAllControllers();break;default:Y(`%cUnrecognized Event: %c${e.messageStatusByte}%c status byte: %c${Object.keys(w).find(E=>w[E]===t.status)}`,I.warn,I.unrecognized,I.warn,I.value);break}}function cs(){for(let e=0;e<16;e++)this.synth.createWorkletChannel(!0),e===xA&&this.synth.setDrums(this.synth.workletProcessorChannels.length-1,!0)}function Do(e){return e.messageData.currentIndex=0,6e7/WA(e.messageData,3)}function ls(){let e=this.currentTime;for(;this.playedTime<e;){let A=this._findFirstEventIndex(),t=this.tracks[A][this.eventIndex[A]];if(this._processEvent(t,A),this.eventIndex[A]++,A=this._findFirstEventIndex(),this.tracks[A].length<=this.eventIndex[A]){if(this.loop){this.setTimeTicks(this.midiData.loop.start);return}this.eventIndex[A]--,this.pause(!0),this.songs.length>1&&this.nextSong();return}let s=this.tracks[A][this.eventIndex[A]];if(this.playedTime+=this.oneTickToSeconds*(s.ticks-t.ticks),this.midiData.loop.end<=t.ticks&&this.loop){this.setTimeTicks(this.midiData.loop.start);return}else if(e>=this.duration){if(this.loop){this.setTimeTicks(this.midiData.loop.start);return}this.eventIndex[A]--,this.pause(!0),this.songs.length>1&&this.nextSong();return}}}function us(){let e=0,A=1/0;return this.tracks.forEach((t,s)=>{this.eventIndex[s]>=t.length||t[this.eventIndex[s]].ticks<A&&(e=s,A=t[this.eventIndex[s]].ticks)}),e}var qA=new Int16Array(127);qA[S.mainVolume]=100;qA[S.expressionController]=127;qA[S.pan]=64;qA[S.releaseTime]=64;qA[S.brightness]=64;qA[S.effects1Depth]=40;function fs(e,A=void 0){if(this.oneTickToSeconds=60/(120*this.midiData.timeDivision),this.synth.resetAllControllers(),this.sendMIDIMessages){this.sendMIDIMessage([w.reset]);for(let C=0;C<He;C++)this.sendMIDIMessage([w.controllerChange|C,S.resetAllControllers,0])}this._resetTimers();let t=this.synth.workletProcessorChannels.length,s=Array(t).fill(8192),n=[];for(let C=0;C<t;C++)n.push({program:-1,bank:0,actualBank:0});let o=C=>C===S.dataDecrement||C===S.dataIncrement||C===S.dataEntryMsb||C===S.dataDecrement||C===S.lsbForControl6DataEntry||C===S.RPNLsb||C===S.RPNMsb||C===S.NRPNLsb||C===S.NRPNMsb||C===S.bankSelect||C===S.lsbForControl0BankSelect||C===S.resetAllControllers,E=[];for(let C=0;C<t;C++)E.push(Array.from(qA));for(;;){let C=this._findFirstEventIndex(),h=this.tracks[C][this.eventIndex[C]];if(A!==void 0){if(h.ticks>=A)break}else if(this.playedTime>=e)break;let c=pe(h.messageStatusByte),d=c.channel+(this.midiPortChannelOffsets[this.midiPorts[C]]||0);switch(c.status){case w.noteOn:case w.noteOff:case w.keySignature:break;case w.pitchBend:s[d]=h.messageData[1]<<7|h.messageData[0];break;case w.programChange:let Q=n[d];Q.program=h.messageData[0],Q.actualBank=Q.bank;break;case w.controllerChange:let l=h.messageData[0];if(o(l))if(this.sendMIDIMessages)this.sendMIDIMessage([w.controllerChange|d%16,l,h.messageData[1]]);else{let m=h.messageData[1];if(l===S.bankSelect){n[d].bank=m;break}this.synth.controllerChange(d,l,m)}else E[d]===void 0&&(E[d]=Array.from(qA)),E[d][l]=h.messageData[1];break;default:this._processEvent(h,C);break}this.eventIndex[C]++,C=this._findFirstEventIndex();let u=this.tracks[C][this.eventIndex[C]];if(u===void 0)return this.stop(),!1;this.playedTime+=this.oneTickToSeconds*(u.ticks-h.ticks)}if(this.sendMIDIMessages){for(let C=0;C<t;C++)if(this.sendMIDIMessage([w.pitchBend|C%16,s[C]&127,s[C]>>7]),E[C].forEach((h,c)=>{h!==qA[c]&&!o(c)&&this.sendMIDIMessage([w.controllerChange|C%16,c,h])}),n[C].program>=0&&n[C].actualBank>=0){let h=n[C].actualBank;this.sendMIDIMessage([w.controllerChange|C%16,S.bankSelect,h]),this.sendMIDIMessage([w.programChange|C%16,n[C].program])}}else for(let C=0;C<t;C++)if(s[C]!==void 0&&this.synth.pitchWheel(C,s[C]>>7,s[C]&127),E[C]!==void 0&&E[C].forEach((h,c)=>{h!==qA[c]&&!o(c)&&this.synth.controllerChange(C,c,h)}),n[C].program>=0&&n[C].actualBank>=0){let h=n[C].actualBank;this.synth.controllerChange(C,S.bankSelect,h),this.synth.programChange(C,n[C].program)}return!0}function ds(e=!1){if(this.midiData!==void 0){if(e){this.currentTime=0;return}if(this.currentTime>=this.duration){this.currentTime=0;return}this.paused&&(this._recalculateStartTime(this.pausedTime),this.pausedTime=void 0),this.sendMIDIMessages||this.playingNotes.forEach(A=>{this.synth.noteOn(A.channel,A.midiNote,A.velocity,!1,!0)}),this.setProcessHandler()}}function Je(e,A,t){if(A<=0)return 0;let s=e.find(o=>o.ticks<A),n=A-s.ticks;return Je(e,A-n,t)+n*60/(s.tempo*t)}function ms(e){this.stop(),this.playingNotes=[],this.pausedTime=void 0,this.post(DA.timeChange,currentTime-Je(this.midiData.tempoChanges,e,this.midiData.timeDivision));let A=this._playTo(0,e);this._recalculateStartTime(this.playedTime),A&&this.play()}function ps(e){this.absoluteStartTime=currentTime-e/this._playbackRate}var qe=class{constructor(A){this.timeDivision=A.timeDivision,this.duration=A.duration,this.tempoChanges=A.tempoChanges,this.copyright=A.copyright,this.tracksAmount=A.tracksAmount,this.lyrics=A.lyrics,this.firstNoteOn=A.firstNoteOn,this.keyRange=A.keyRange,this.lastVoiceEventTick=A.lastVoiceEventTick,this.midiPorts=A.midiPorts,this.midiPortChannelOffsets=A.midiPortChannelOffsets,this.usedChannelsOnTrack=A.usedChannelsOnTrack,this.loop=A.loop,this.midiName=A.midiName,this.fileName=A.fileName,this.rawMidiName=A.rawMidiName,this.isEmbedded=A.embeddedSoundFont!==void 0,this.RMIDInfo=A.RMIDInfo,this.bankOffset=A.bankOffset}},Ci={duration:99999,firstNoteOn:0,loop:{start:0,end:123456},lastVoiceEventTick:123456,lyrics:[],copyright:"",midiPorts:[],midiPortChannelOffsets:[],tracksAmount:0,tempoChanges:[{ticks:0,tempo:120}],fileName:"NOT_LOADED.mid",midiName:"Loading...",rawMidiName:new Uint8Array([76,111,97,100,105,110,103,46,46,46]),usedChannelsOnTrack:[],timeDivision:0,keyRange:{min:0,max:127},isEmbedded:!1,RMIDInfo:void 0,bankOffset:0};function D(e,A){let t=0;for(let s=0;s<A;s++)t|=e[e.currentIndex++]<<s*8;return t>>>0}function ie(e,A,t){for(let s=0;s<t;s++)e[e.currentIndex++]=A>>s*8&255}function J(e,A){e[e.currentIndex++]=A&255,e[e.currentIndex++]=A>>8}function cA(e,A){ie(e,A,4)}function Ie(e,A){let t=A<<8|e;return t>32767?t-65536:t}function Ss(e){return e>127?e-256:e}function V(e,A,t=void 0,s=!0){if(t){let n=e.slice(e.currentIndex,e.currentIndex+A);return e.currentIndex+=A,new TextDecoder(t.replace(/[^\x20-\x7E]/g,"")).decode(n.buffer)}else{let n=!1,o="";for(let E=0;E<A;E++){let C=e[e.currentIndex++];if(!n){if(C<32||C>127){if(s){n=!0;continue}else if(C===0){n=!0;continue}}o+=String.fromCharCode(C)}}return o}}function kA(e,A,t=0){t>0&&A.length>t&&(A=A.slice(0,t));for(let s=0;s<A.length;s++)e[e.currentIndex++]=A.charCodeAt(s);if(t>A.length)for(let s=0;s<t-A.length;s++)e[e.currentIndex++]=0;return e}var j=class{constructor(A,t,s){this.header=A,this.size=t,this.chunkData=s}};function O(e,A=!0,t=!1){let s=V(e,4),n=D(e,4),o;return A&&(o=new H(e.buffer.slice(e.currentIndex,e.currentIndex+n))),(A||t)&&(e.currentIndex+=n),n%2!==0&&e[e.currentIndex]===0&&e.currentIndex++,new j(s,n,o)}function tA(e,A=void 0){let t=8+e.size;e.size%2!==0&&t++,A&&(t+=A.length);let s=new H(t);return A&&(s.set(A,s.currentIndex),s.currentIndex+=A.length),kA(s,e.header),cA(s,t-8-(A?.length||0)),s.set(e.chunkData,s.currentIndex),s}function pA(e,A){return e.find(t=>t.header!=="LIST"?!1:(t.chunkData.currentIndex=0,V(t.chunkData,4)===A))}function Ke(e){let A=0;for(;e;){let t=e[e.currentIndex++];if(A=A<<7|t&127,t>>7!==1)break}return A}var a={INVALID:-1,startAddrsOffset:0,endAddrOffset:1,startloopAddrsOffset:2,endloopAddrsOffset:3,startAddrsCoarseOffset:4,modLfoToPitch:5,vibLfoToPitch:6,modEnvToPitch:7,initialFilterFc:8,initialFilterQ:9,modLfoToFilterFc:10,modEnvToFilterFc:11,endAddrsCoarseOffset:12,modLfoToVolume:13,unused1:14,chorusEffectsSend:15,reverbEffectsSend:16,pan:17,unused2:18,unused3:19,unused4:20,delayModLFO:21,freqModLFO:22,delayVibLFO:23,freqVibLFO:24,delayModEnv:25,attackModEnv:26,holdModEnv:27,decayModEnv:28,sustainModEnv:29,releaseModEnv:30,keyNumToModEnvHold:31,keyNumToModEnvDecay:32,delayVolEnv:33,attackVolEnv:34,holdVolEnv:35,decayVolEnv:36,sustainVolEnv:37,releaseVolEnv:38,keyNumToVolEnvHold:39,keyNumToVolEnvDecay:40,instrument:41,reserved1:42,keyRange:43,velRange:44,startloopAddrsCoarseOffset:45,keyNum:46,velocity:47,initialAttenuation:48,reserved2:49,endloopAddrsCoarseOffset:50,coarseTune:51,fineTune:52,sampleID:53,sampleModes:54,reserved3:55,scaleTuning:56,exclusiveClass:57,overridingRootKey:58,unused5:59,endOper:60},L=[];L[a.startAddrsOffset]={min:0,max:32768,def:0};L[a.endAddrOffset]={min:-32768,max:32768,def:0};L[a.startloopAddrsOffset]={min:-32768,max:32768,def:0};L[a.endloopAddrsOffset]={min:-32768,max:32768,def:0};L[a.startAddrsCoarseOffset]={min:0,max:32768,def:0};L[a.modLfoToPitch]={min:-12e3,max:12e3,def:0};L[a.vibLfoToPitch]={min:-12e3,max:12e3,def:0};L[a.modEnvToPitch]={min:-12e3,max:12e3,def:0};L[a.initialFilterFc]={min:1500,max:13500,def:13500};L[a.initialFilterQ]={min:0,max:960,def:0};L[a.modLfoToFilterFc]={min:-12e3,max:12e3,def:0};L[a.modEnvToFilterFc]={min:-12e3,max:12e3,def:0};L[a.endAddrsCoarseOffset]={min:-32768,max:32768,def:0};L[a.modLfoToVolume]={min:-960,max:960,def:0};L[a.chorusEffectsSend]={min:0,max:1e3,def:0};L[a.reverbEffectsSend]={min:0,max:1e3,def:0};L[a.pan]={min:-500,max:500,def:0};L[a.delayModLFO]={min:-12e3,max:5e3,def:-12e3};L[a.freqModLFO]={min:-16e3,max:4500,def:0};L[a.delayVibLFO]={min:-12e3,max:5e3,def:-12e3};L[a.freqVibLFO]={min:-16e3,max:4500,def:0};L[a.delayModEnv]={min:-12e3,max:5e3,def:-12e3};L[a.attackModEnv]={min:-12e3,max:8e3,def:-12e3};L[a.holdModEnv]={min:-12e3,max:5e3,def:-12e3};L[a.decayModEnv]={min:-12e3,max:8e3,def:-12e3};L[a.sustainModEnv]={min:0,max:1e3,def:0};L[a.releaseModEnv]={min:-12e3,max:8e3,def:-12e3};L[a.keyNumToModEnvHold]={min:-1200,max:1200,def:0};L[a.keyNumToModEnvDecay]={min:-1200,max:1200,def:0};L[a.delayVolEnv]={min:-12e3,max:5e3,def:-12e3};L[a.attackVolEnv]={min:-12e3,max:8e3,def:-12e3};L[a.holdVolEnv]={min:-12e3,max:5e3,def:-12e3};L[a.decayVolEnv]={min:-12e3,max:8e3,def:-12e3};L[a.sustainVolEnv]={min:0,max:1440,def:0};L[a.releaseVolEnv]={min:-7200,max:8e3,def:-12e3};L[a.keyNumToVolEnvHold]={min:-1200,max:1200,def:0};L[a.keyNumToVolEnvDecay]={min:-1200,max:1200,def:0};L[a.startloopAddrsCoarseOffset]={min:-32768,max:32768,def:0};L[a.keyNum]={min:-1,max:127,def:-1};L[a.velocity]={min:-1,max:127,def:-1};L[a.initialAttenuation]={min:-250,max:1440,def:0};L[a.endloopAddrsCoarseOffset]={min:-32768,max:32768,def:0};L[a.coarseTune]={min:-120,max:120,def:0};L[a.fineTune]={min:-99,max:99,def:0};L[a.scaleTuning]={min:0,max:1200,def:100};L[a.exclusiveClass]={min:0,max:99999,def:0};L[a.overridingRootKey]={min:-1,max:127,def:-1};var b=class{constructor(A=a.INVALID,t=0){if(this.generatorType=A,t===void 0)throw new Error("No value provided.");let s=L[A];this.generatorValue=Math.round(t),s!==void 0&&(this.generatorValue=Math.max(s.min,Math.min(s.max,this.generatorValue)))}generatorType=a.INVALID;generatorValue=0};function ys(e,A,t){let s=L[e]||{min:0,max:32768,def:0},n=A.find(h=>h.generatorType===e),o=0;n&&(o=n.generatorValue);let E=t.find(h=>h.generatorType===e),C=s.def;return E&&(C=E.generatorValue),Math.max(s.min,Math.min(s.max,C+o))}var ct=class extends b{constructor(A){super();let t=A.currentIndex;this.generatorType=A[t+1]<<8|A[t],this.generatorValue=Ie(A[t+2],A[t+3]),A.currentIndex+=4}};function lt(e){let A=[];for(;e.chunkData.length>e.chunkData.currentIndex;)A.push(new ct(e.chunkData));return A.length>1&&A.pop(),A}var P={noController:0,noteOnVelocity:2,noteOnKeyNum:3,polyPressure:10,channelPressure:13,pitchWheel:14,pitchWheelRange:16,link:127},lA={linear:0,concave:1,convex:2,switch:3},ko=[];for(let e=0;e<4;e++)ko.push([[],[]]);var rA=class e{constructor(A){A.srcEnum?(this.modulatorSource=A.srcEnum,this.modulatorDestination=A.dest,this.modulationSecondarySrc=A.secSrcEnum,this.transformAmount=A.amt,this.transformType=A.transform):(this.modulatorSource=D(A,2),this.modulatorDestination=D(A,2),this.transformAmount=Ie(A[A.currentIndex++],A[A.currentIndex++]),this.modulationSecondarySrc=D(A,2),this.transformType=D(A,2)),this.modulatorDestination>58&&(this.modulatorDestination=a.INVALID),this.sourcePolarity=this.modulatorSource>>9&1,this.sourceDirection=this.modulatorSource>>8&1,this.sourceUsesCC=this.modulatorSource>>7&1,this.sourceIndex=this.modulatorSource&127,this.sourceCurveType=this.modulatorSource>>10&3,this.secSrcPolarity=this.modulationSecondarySrc>>9&1,this.secSrcDirection=this.modulationSecondarySrc>>8&1,this.secSrcUsesCC=this.modulationSecondarySrc>>7&1,this.secSrcIndex=this.modulationSecondarySrc&127,this.secSrcCurveType=this.modulationSecondarySrc>>10&3}sumTransform(A){return new e({srcEnum:this.modulatorSource,secSrcEnum:this.modulationSecondarySrc,dest:this.modulatorDestination,transform:this.transformType,amt:this.transformAmount+A.transformAmount})}debugString(){function A(n,o){return Object.keys(n).find(E=>n[E]===o)}let t=A(lA,this.sourceCurveType);t+=this.sourcePolarity===0?" unipolar ":" bipolar ",t+=this.sourceDirection===0?"forwards ":"backwards ",this.sourceUsesCC?t+=A(S,this.sourceIndex):t+=A(P,this.sourceIndex);let s=A(lA,this.secSrcCurveType);return s+=this.secSrcPolarity===0?" unipolar ":" bipolar ",s+=this.secSrcCurveType===0?"forwards ":"backwards ",this.secSrcUsesCC?s+=A(S,this.secSrcIndex):s+=A(P,this.secSrcIndex),`Modulator:
        Source: ${t}
        Secondary source: ${s}
