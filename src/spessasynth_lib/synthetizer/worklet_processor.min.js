...
`+this.soundFontInfo.ISBJ,delete this.soundFontInfo.ISBJ);for(let[B,h]of Object.entries(this.soundFontInfo))m(`%c"${B}": %c"${h}"`,r.info,r.recognized);let o=s.find(B=>B.header==="colh");o||(V(),this.parsingError("No colh chunk!")),this.instrumentAmount=D(o.chunkData,4),m(`%cInstruments amount: %c${this.instrumentAmount}`,r.info,r.recognized);let i=DA(s,"wvpl");i||(V(),this.parsingError("No wvpl chunk!")),this.readDLSSamples(i);let g=DA(s,"lins");g||(V(),this.parsingError("No lins chunk!")),this.readDLSInstrumentList(g),this.presets.sort((B,h)=>B.program-h.program+(B.bank-h.bank)),m(`%cParsing finished! %c"${this.soundFontInfo.INAM||"UNNAMED"}"%c has %c${this.presets.length} %cpresets,
        %c${this.instruments.length}%c instruments and %c${this.samples.length}%c samples.`,r.info,r.recognized,r.info,r.recognized,r.info,r.recognized,r.info,r.recognized,r.info),V()}verifyHeader(A,e){A.header.toLowerCase()!==e.toLowerCase()&&(V(),this.parsingError(`Invalid DLS chunk header! Expected "${e.toLowerCase()}" got "${A.header.toLowerCase()}"`))}verifyText(A,e){A.toLowerCase()!==e.toLowerCase()&&(V(),this.parsingError(`FourCC error: Expected "${e.toLowerCase()}" got "${A.toLowerCase()}"`))}parsingError(A){throw new Error(`DLS parse error: ${A} The file may be corrupted.`)}destroySoundfont(){super.destroySoundfont(),delete this.dataArray}};WA.prototype.readDLSInstrumentList=$n;WA.prototype.readDLSInstrument=Ao;WA.prototype.readRegion=no;WA.prototype.readLart=so;WA.prototype.readDLSSamples=ro;var Jt=class extends me{constructor(A,e,s,n,o,i,g,B,h,d,u,l,Q){super(A,i,g,B,h,d,n-e/2,o-e/2),this.sampleName=A,this.sampleStartIndex=e,this.sampleEndIndex=s,this.isSampleLoaded=!1,this.sampleID=l,this.sampleLength=this.sampleEndIndex-this.sampleStartIndex,this.sampleDataArray=u,this.sampleData=new Float32Array(0),this.isCompressed&&(this.sampleLoopStartIndex+=this.sampleStartIndex/2,this.sampleLoopEndIndex+=this.sampleStartIndex/2,this.sampleLength=99999999),this.isDataRaw=Q}getRawData(){let A=this.sampleDataArray;if(this.isCompressed){if(this.compressedData)return this.compressedData;let e=A.currentIndex;return A.slice(this.sampleStartIndex/2+e,this.sampleEndIndex/2+e)}else{if(!this.isDataRaw)throw new Error("Writing SF2Pack samples is not supported.");let e=A.currentIndex;return A.slice(e+this.sampleStartIndex,e+this.sampleEndIndex)}}decodeVorbis(){if(this.sampleLength<1)return;let A=this.sampleDataArray,e=A.currentIndex,s=A.slice(this.sampleStartIndex/2+e,this.sampleEndIndex/2+e);this.sampleData=new Float32Array(0);try{let n=VA.decode(s.buffer);this.sampleData=n.data[0]}catch(n){throw new Error(`Ogg Vorbis decode error: ${n}`)}}getAudioData(){return this.isSampleLoaded?this.sampleData:this.sampleLength<1?new Float32Array(1):this.isCompressed?(this.decodeVorbis(),this.isSampleLoaded=!0,this.sampleData):this.isDataRaw?this.loadUncompressedData():this.getUncompressedReadyData()}loadUncompressedData(){if(this.isCompressed)return H("Trying to load a compressed sample via loadUncompressedData()... aborting!"),new Float32Array(0);let A=new Float32Array(this.sampleLength/2),e=this.sampleDataArray.currentIndex,s=new Int16Array(this.sampleDataArray.slice(e+this.sampleStartIndex,e+this.sampleEndIndex).buffer);for(let n=0;n<s.length;n++)A[n]=s[n]/32768;return this.sampleData=A,this.isSampleLoaded=!0,A}getUncompressedReadyData(){let A=this.sampleDataArray.slice(this.sampleStartIndex/2,this.sampleEndIndex/2);return this.sampleData=A,this.isSampleLoaded=!0,A}};function io(t,A,e=!0){let s=[],n=0;for(;t.chunkData.length>t.chunkData.currentIndex;){let o=jo(n,t.chunkData,A,e);s.push(o),n++}return s.length>1&&s.pop(),s}function jo(t,A,e,s){let n=O(A,20),o=D(A,4)*2,i=D(A,4)*2,g=D(A,4),B=D(A,4),h=D(A,4),d=A[A.currentIndex++];d===255&&(d=60);let u=xs(A[A.currentIndex++]),l=D(A,2),Q=D(A,2);return new Jt(n,o,i,g,B,h,d,u,l,Q,e,t,s)}var qt=class extends U{constructor(A){super();let e=A.currentIndex;this.generatorType=A[e+1]<<8|A[e],this.generatorValue=$A(A[e+2],A[e+3]),A.currentIndex+=4}};function Pt(t){let A=[];for(;t.chunkData.length>t.chunkData.currentIndex;)A.push(new qt(t.chunkData));return A.length>1&&A.pop(),A}var Kt=class extends fe{constructor(A){super(),this.instrumentName=O(A.chunkData,20).trim(),this.instrumentZoneIndex=D(A.chunkData,2),this.instrumentZonesAmount=0}getInstrumentZones(A,e){this.instrumentZonesAmount=A;for(let s=this.instrumentZoneIndex;s<this.instrumentZonesAmount+this.instrumentZoneIndex;s++)this.instrumentZones.push(e[s])}};function ao(t,A){let e=[];for(;t.chunkData.length>t.chunkData.currentIndex;){let s=new Kt(t);if(e.length>0){let n=s.instrumentZoneIndex-e[e.length-1].instrumentZoneIndex;e[e.length-1].getInstrumentZones(n,A)}e.push(s)}return e.length>1&&e.pop(),e}var Vt=class extends Ae{constructor(A){super(),this.generatorZoneStartIndex=D(A,2),this.modulatorZoneStartIndex=D(A,2),this.modulatorZoneSize=0,this.generatorZoneSize=0,this.isGlobal=!0}setZoneSize(A,e){this.modulatorZoneSize=A,this.generatorZoneSize=e}getGenerators(A){for(let e=this.generatorZoneStartIndex;e<this.generatorZoneStartIndex+this.generatorZoneSize;e++)this.generators.push(A[e])}getModulators(A){for(let e=this.modulatorZoneStartIndex;e<this.modulatorZoneStartIndex+this.modulatorZoneSize;e++)this.modulators.push(A[e])}getSample(A){let e=this.generators.find(s=>s.generatorType===a.sampleID);e&&(this.sample=A[e.generatorValue],this.isGlobal=!1,this.sample.useCount++)}getKeyRange(){let A=this.generators.find(e=>e.generatorType===a.keyRange);A&&(this.keyRange.min=A.generatorValue&127,this.keyRange.max=A.generatorValue>>8&127)}getVelRange(){let A=this.generators.find(e=>e.generatorType===a.velRange);A&&(this.velRange.min=A.generatorValue&127,this.velRange.max=A.generatorValue>>8&127)}};function Io(t,A,e,s){let n=[];for(;t.chunkData.length>t.chunkData.currentIndex;){let o=new Vt(t.chunkData);if(n.length>0){let i=o.modulatorZoneStartIndex-n[n.length-1].modulatorZoneStartIndex,g=o.generatorZoneStartIndex-n[n.length-1].generatorZoneStartIndex;n[n.length-1].setZoneSize(i,g),n[n.length-1].getGenerators(A),n[n.length-1].getModulators(e),n[n.length-1].getSample(s),n[n.length-1].getKeyRange(),n[n.length-1].getVelRange()}n.push(o)}return n.length>1&&n.pop(),n}var Ot=class extends de{constructor(A){super(),this.generatorZoneStartIndex=D(A,2),this.modulatorZoneStartIndex=D(A,2),this.modulatorZoneSize=0,this.generatorZoneSize=0,this.isGlobal=!0}setZoneSize(A,e){this.modulatorZoneSize=A,this.generatorZoneSize=e}getGenerators(A){for(let e=this.generatorZoneStartIndex;e<this.generatorZoneStartIndex+this.generatorZoneSize;e++)this.generators.push(A[e])}getModulators(A){for(let e=this.modulatorZoneStartIndex;e<this.modulatorZoneStartIndex+this.modulatorZoneSize;e++)this.modulators.push(A[e])}getInstrument(A){let e=this.generators.find(s=>s.generatorType===a.instrument);e&&(this.instrument=A[e.generatorValue],this.instrument.addUseCount(),this.isGlobal=!1)}getKeyRange(){let A=this.generators.find(e=>e.generatorType===a.keyRange);A&&(this.keyRange.min=A.generatorValue&127,this.keyRange.max=A.generatorValue>>8&127)}getVelRange(){let A=this.generators.find(e=>e.generatorType===a.velRange);A&&(this.velRange.min=A.generatorValue&127,this.velRange.max=A.generatorValue>>8&127)}};function go(t,A,e,s){let n=[];for(;t.chunkData.length>t.chunkData.currentIndex;){let o=new Ot(t.chunkData);if(n.length>0){let i=o.modulatorZoneStartIndex-n[n.length-1].modulatorZoneStartIndex,g=o.generatorZoneStartIndex-n[n.length-1].generatorZoneStartIndex;n[n.length-1].setZoneSize(i,g),n[n.length-1].getGenerators(A),n[n.length-1].getModulators(e),n[n.length-1].getInstrument(s),n[n.length-1].getKeyRange(),n[n.length-1].getVelRange()}n.push(o)}return n.length>1&&n.pop(),n}var Zt=class extends ue{constructor(A,e){super(e),this.presetName=O(A.chunkData,20).trim().replace(/\d{3}:\d{3}/,""),this.program=D(A.chunkData,2),this.bank=D(A.chunkData,2),this.presetZoneStartIndex=D(A.chunkData,2),this.library=D(A.chunkData,4),this.genre=D(A.chunkData,4),this.morphology=D(A.chunkData,4),this.presetZonesAmount=0}getPresetZones(A,e){this.presetZonesAmount=A;for(let s=this.presetZoneStartIndex;s<this.presetZonesAmount+this.presetZoneStartIndex;s++)this.presetZones.push(e[s])}};function Co(t,A,e){let s=[];for(;t.chunkData.length>t.chunkData.currentIndex;){let n=new Zt(t,e);if(s.length>0){let o=n.presetZoneStartIndex-s[s.length-1].presetZoneStartIndex;s[s.length-1].getPresetZones(o,A)}s.push(n)}return s.length>1&&s.pop(),s}var Xt=class extends _{constructor(A){super({srcEnum:D(A,2),dest:D(A,2),amt:$A(A[A.currentIndex++],A[A.currentIndex++]),secSrcEnum:D(A,2),transform:D(A,2)})}};function at(t){let A=[];for(;t.chunkData.length>t.chunkData.currentIndex;)A.push(new Xt(t.chunkData));return A}var It=class extends ie{constructor(A,e=!0){super(),e&&console.warn("Using the constructor directly is deprecated. Use loadSoundFont instead."),this.dataArray=new v(A),se("%cParsing SoundFont...",r.info),this.dataArray||(V(),this.parsingError("No data provided!"));let s=Z(this.dataArray,!1);this.verifyHeader(s,"riff");let n=O(this.dataArray,4).toLowerCase();if(n!=="sfbk"&&n!=="sfpk")throw V(),new SyntaxError(`Invalid soundFont! Expected "sfbk" or "sfpk" got "${n}"`);let o=n==="sfpk",i=Z(this.dataArray);for(this.verifyHeader(i,"list"),O(i.chunkData,4);i.chunkData.length>i.chunkData.currentIndex;){let eA=Z(i.chunkData),QA;switch(eA.header.toLowerCase()){case"ifil":case"iver":QA=`${D(eA.chunkData,2)}.${D(eA.chunkData,2)}`,this.soundFontInfo[eA.header]=QA;break;case"icmt":QA=O(eA.chunkData,eA.chunkData.length,void 0,!1),this.soundFontInfo[eA.header]=QA;break;case"dmod":let IA=at(eA);IA.pop(),QA=`Modulators: ${IA.length}`;let mA=this.defaultModulators;this.defaultModulators=IA,this.defaultModulators.push(...mA.filter(Le=>!this.defaultModulators.find(MA=>_.isIdentical(Le,MA)))),this.soundFontInfo[eA.header]=eA.chunkData;break;default:QA=O(eA.chunkData,eA.chunkData.length),this.soundFontInfo[eA.header]=QA}m(`%c"${eA.header}": %c"${QA}"`,r.info,r.recognized)}let g=Z(this.dataArray,!1);this.verifyHeader(g,"list"),this.verifyText(O(this.dataArray,4),"sdta"),m("%cVerifying smpl chunk...",r.warn);let B=Z(this.dataArray,!1);this.verifyHeader(B,"smpl");let h;if(o){m("%cSF2Pack detected, attempting to decode the smpl chunk...",r.info);try{h=VA.decode(this.dataArray.buffer.slice(this.dataArray.currentIndex,this.dataArray.currentIndex+g.size-12)).data[0]}catch(eA){throw V(),new Error(`SF2Pack Ogg Vorbis decode error: ${eA}`)}m(`%cDecoded the smpl chunk! Length: %c${h.length}`,r.info,r.value)}else h=this.dataArray,this.sampleDataStartIndex=this.dataArray.currentIndex;m(`%cSkipping sample chunk, length: %c${g.size-12}`,r.info,r.value),this.dataArray.currentIndex+=g.size-12,m("%cLoading preset data chunk...",r.warn);let d=Z(this.dataArray);this.verifyHeader(d,"list"),O(d.chunkData,4);let u=Z(d.chunkData);this.verifyHeader(u,"phdr");let l=Z(d.chunkData);this.verifyHeader(l,"pbag");let Q=Z(d.chunkData);this.verifyHeader(Q,"pmod");let p=Z(d.chunkData);this.verifyHeader(p,"pgen");let y=Z(d.chunkData);this.verifyHeader(y,"inst");let w=Z(d.chunkData);this.verifyHeader(w,"ibag");let k=Z(d.chunkData);this.verifyHeader(k,"imod");let L=Z(d.chunkData);this.verifyHeader(L,"igen");let R=Z(d.chunkData);this.verifyHeader(R,"shdr"),this.dataArray.currentIndex=this.sampleDataStartIndex,this.samples.push(...io(R,h,!o));let N=Pt(L),G=at(k),C=Io(w,N,G,this.samples);this.instruments=ao(y,C);let iA=Pt(p),j=at(Q),AA=go(l,iA,j,this.instruments);this.presets.push(...Co(u,AA,this.defaultModulators)),this.presets.sort((eA,QA)=>eA.program-QA.program+(eA.bank-QA.bank)),m(`%cParsing finished! %c"${this.soundFontInfo.INAM}"%c has %c${this.presets.length} %cpresets,
        %c${this.instruments.length}%c instruments and %c${this.samples.length}%c samples.`,r.info,r.recognized,r.info,r.recognized,r.info,r.recognized,r.info,r.recognized,r.info),V(),o&&delete this.dataArray}verifyHeader(A,e){A.header.toLowerCase()!==e.toLowerCase()&&(V(),this.parsingError(`Invalid chunk header! Expected "${e.toLowerCase()}" got "${A.header.toLowerCase()}"`))}verifyText(A,e){A.toLowerCase()!==e.toLowerCase()&&(V(),this.parsingError(`Invalid FourCC: Expected "${e.toLowerCase()}" got "${A.toLowerCase()}"\``))}destroySoundfont(){super.destroySoundfont(),delete this.dataArray}};function Ne(t){let A=t.slice(8,12),e=new v(A);return O(e,4,void 0,!1).toLowerCase()==="dls "?new WA(t):new It(t,!1)}function Eo(t,A,e=!1){let s=this.workletProcessorChannels[t];if(s===void 0){H(`Trying to access channel ${t} which does not exist... ignoring!`);return}if(s.lockPreset)return;let n=KA(s),o,i;if(this.overrideSoundfont){let g=n===128?128:n-this.soundfontBankOffset,B=this.overrideSoundfont.getPresetNoFallback(g,A);B?(o=n,i=B,s.presetUsesOverride=!0):(i=this.soundfontManager.getPreset(n,A),o=i.bank,s.presetUsesOverride=!1)}else i=this.soundfontManager.getPreset(n,A),o=i.bank,s.presetUsesOverride=!1;this.setPreset(t,i),this.callEvent("programchange",{channel:t,program:i.program,bank:o,userCalled:e})}function Bo(t,A){if(this.overrideSoundfont){let e=t===128?128:t-this.soundfontBankOffset,s=this.overrideSoundfont.getPresetNoFallback(e,A);if(s)return s}return this.soundfontManager.getPreset(t,A)}function ho(t,A){if(!this.workletProcessorChannels[t].lockPreset){delete this.workletProcessorChannels[t].preset,this.workletProcessorChannels[t].preset=A,this.workletProcessorChannels[t].cachedVoices=[];for(let e=0;e<128;e++)this.workletProcessorChannels[t].cachedVoices.push([])}}function co(t,A){let e=this.workletProcessorChannels[t];e.lockPreset||e.drumChannel!==A&&(A?(e.channelTransposeKeyShift=0,e.drumChannel=!0,this.setPreset(t,this.getPreset(KA(e),e.preset.program))):(e.drumChannel=!1,this.setPreset(t,this.getPreset(KA(e),e.preset.program))),e.presetUsesOverride=!1,this.callEvent("drumchange",{channel:t,isDrumChannel:e.drumChannel}),this.sendChannelProperties())}function Qo(){let t=this.soundfontManager.getPresetList();this.overrideSoundfont!==void 0&&this.overrideSoundfont.presets.forEach(A=>{let e=A.bank===128?128:A.bank+this.soundfontBankOffset,s=t.find(n=>n.bank===e&&n.program===A.program);s!==void 0?s.presetName=A.presetName:t.push({presetName:A.presetName,bank:e,program:A.program})}),this.callEvent("presetlistchange",t)}function lo(t=!0,A=!0){this.stopAllChannels(!0),A&&(delete this.overrideSoundfont,this.overrideSoundfont=void 0),this.defaultPreset=this.getPreset(0,0),this.drumPreset=this.getPreset(128,0);for(let e=0;e<this.workletProcessorChannels.length;e++){let s=this.workletProcessorChannels[e];s.cachedVoices=[];for(let n=0;n<128;n++)s.cachedVoices.push([]);(!A||A&&s.presetUsesOverride)&&(s.lockPreset=!1),this.programChange(e,s.preset.program)}t&&this.sendPresetList()}function uo(t,A=!1){this.clearSoundFont(!1,A);try{A?(this.overrideSoundfont=Ne(t),this.overrideSoundfont.setSampleIDOffset(this.soundfontManager.totalSoundfontOffset)):this.soundfontManager.reloadManager(t)}catch(e){this.post({messageType:uA.soundfontError,messageData:e});return}this.defaultPreset=this.getPreset(0,0),this.drumPreset=this.getPreset(128,0),this.workletProcessorChannels.forEach((e,s)=>{this.programChange(s,e.preset.program)}),this.post({messageType:uA.ready,messageData:void 0}),this.sendPresetList(),m("%cSpessaSynth is ready!",r.recognized)}function fo(t,A){this.soundfontBankOffset=A,this.reloadSoundFont(t,!0),this.overrideSoundfont.samples.forEach(e=>e.getAudioData()),this._snapshot!==void 0&&(this.applySynthesizerSnapshot(this._snapshot),this.resetAllControllers())}function mo(){let A={channelSnapshots:this.workletProcessorChannels.map(e=>({program:e.preset.program,bank:KA(e),lockPreset:e.lockPreset,patchName:e.preset.presetName,midiControllers:e.midiControllers,lockedControllers:e.lockedControllers,customControllers:e.customControllers,channelVibrato:e.channelVibrato,lockVibrato:e.lockGSNRPNParams,channelTransposeKeyShift:e.channelTransposeKeyShift,channelOctaveTuning:e.channelOctaveTuning,keyCentTuning:e.keyCentTuning,velocityOverride:e.velocityOverride,isMuted:e.isMuted,drumChannel:e.drumChannel})),mainVolume:this.midiVolume,pan:this.pan,transposition:this.transposition,system:this.system,interpolation:this.interpolationType,keyMappings:this.keyModifierManager.getMappings()};this.post({messageType:uA.synthesizerSnapshot,messageData:A})}function po(t){for(this.system=t.system,this.setMasterGain(t.mainVolume),this.setMasterPan(t.pan),this.transposeAllChannels(t.transposition),this.interpolationType=t.interpolation,this.keyModifierManager.setMappings(t.keyMappings);this.workletProcessorChannels.length<t.channelSnapshots.length;)this.createWorkletChannel();t.channelSnapshots.forEach((A,e)=>{let s=this.workletProcessorChannels[e];this.muteChannel(e,A.isMuted),this.setDrums(e,A.drumChannel),s.midiControllers=A.midiControllers,s.lockedControllers=A.lockedControllers,s.customControllers=A.customControllers,s.channelVibrato=A.channelVibrato,s.lockGSNRPNParams=A.lockVibrato,s.channelTransposeKeyShift=A.channelTransposeKeyShift,s.channelOctaveTuning=A.channelOctaveTuning,s.velocityOverride=A.velocityOverride,s.lockPreset=!1,zA(s,A.bank),this.programChange(e,A.program),s.lockPreset=A.lockPreset}),m("%cFinished restoring controllers!",r.info)}var gt=class{constructor(A,e){this.ready=e,this.totalSoundfontOffset=0,this.reloadManager(A)}_assingSampleOffsets(){let A=0;this.soundfontList.forEach(e=>{e.soundfont.setSampleIDOffset(A),A+=e.soundfont.samples.length}),this.totalSoundfontOffset=A}generatePresetList(){this._assingSampleOffsets();let A={};for(let e=this.soundfontList.length-1;e>=0;e--){let s=this.soundfontList[e],n=new Set;for(let o of s.soundfont.presets){let i=`${o.bank+s.bankOffset}-${o.program}`;n.has(i)||(n.add(i),A[i]=o.presetName)}}this.presetList=[];for(let[e,s]of Object.entries(A)){let n=e.split("-");this.presetList.push({presetName:s,program:parseInt(n[1]),bank:parseInt(n[0])})}}handleMessage(A,e){switch(A){case Ee.addNewSoundFont:this.addNewSoundFont(e[0],e[1],e[2]);break;case Ee.reloadSoundFont:this.reloadManager(e);break;case Ee.deleteSoundFont:this.deleteSoundFont(e);break;case Ee.rearrangeSoundFonts:this.rearrangeSoundFonts(e)}}getPresetList(){return this.presetList.slice()}reloadManager(A){let e=Ne(A);this.soundfontList=[],this.soundfontList.push({id:"main",bankOffset:0,soundfont:e}),this.generatePresetList(),this.ready()}deleteSoundFont(A){if(this.soundfontList.length===0){H("1 soundfont left. Aborting!");return}let e=this.soundfontList.findIndex(s=>s.id===A);if(e===-1){H(`No soundfont with id of "${A}" found. Aborting!`);return}delete this.soundfontList[e].soundfont.presets,delete this.soundfontList[e].soundfont.instruments,delete this.soundfontList[e].soundfont.samples,this.soundfontList.splice(e,1),this.generatePresetList()}addNewSoundFont(A,e,s){if(this.soundfontList.find(n=>n.id===e)!==void 0)throw new Error("Cannot overwrite the existing soundfont. Use soundfontManager.delete(id) instead.");this.soundfontList.push({id:e,soundfont:Ne(A),bankOffset:s}),this.generatePresetList(),this.ready()}rearrangeSoundFonts(A){this.soundfontList.sort((e,s)=>A.indexOf(e.id)-A.indexOf(s.id)),this.generatePresetList()}getPreset(A,e){if(this.soundfontList.length<1)throw new Error("No soundfonts! This should never happen.");for(let s of this.soundfontList){let n=s.soundfont.getPresetNoFallback(A-s.bankOffset,e);if(n!==void 0)return n}if(A!==128){for(let s of this.soundfontList){let n=s.soundfont.presets.find(o=>o.program===e);if(n)return n}return this.soundfontList[0].soundfont.presets[0]}else{for(let s of this.soundfontList){let n=s.soundfont.presets.find(o=>o.bank===128);if(n)return n}return this.soundfontList[0].soundfont.presets[0]}}destroyManager(){this.soundfontList.forEach(A=>{A.soundfont.destroySoundfont()}),delete this.soundfontList}};var Ct=class{sampleData;playbackStep=0;cursor=0;rootKey=0;loopStart=0;loopEnd=0;end=0;loopingMode=0;isLooping=!1;constructor(A,e,s,n,o,i,g,B){this.sampleData=A,this.playbackStep=e,this.cursor=s,this.rootKey=n,this.loopStart=o,this.loopEnd=i,this.end=g,this.loopingMode=B,this.isLooping=this.loopingMode===1||this.loopingMode===3}},be=class t{sample;filter=new le;generators;modulators=[];modulatedGenerators;finished=!1;isInRelease=!1;channelNumber=0;velocity=0;midiNote=0;pressure=0;targetKey=0;modulationEnvelope=new UA;volumeEnvelope;startTime=0;releaseStartTime=1/0;currentTuningCents=0;currentTuningCalculated=1;currentPan=.5;realKey;constructor(A,e,s,n,o,i,g,B,h,d){this.sample=e,this.generators=h,this.modulatedGenerators=new Int16Array(h),this.modulators=d,this.velocity=n,this.midiNote=s,this.channelNumber=o,this.startTime=i,this.targetKey=g,this.realKey=B,this.volumeEnvelope=new TA(A,h[a.sustainVolEnv])}static copy(A,e){let s=A.sample,n=new Ct(s.sampleData,s.playbackStep,s.cursor,s.rootKey,s.loopStart,s.loopEnd,s.end,s.loopingMode);return new t(A.volumeEnvelope.sampleRate,n,A.midiNote,A.velocity,A.channelNumber,e,A.targetKey,A.realKey,A.generators,A.modulators.map(o=>_.copy(o)))}};function yo(t,A,e,s,n,o,i=!1){let g,B=s.cachedVoices[A][e],h=this.keyModifierManager.hasOverridePatch(t,A);if(B!==void 0&&!h)return B.map(l=>be.copy(l,n));let d=!0,u=s.preset;if(h){d=!1;let l=this.keyModifierManager.getPatch(t,A);u=this.soundfontManager.getPreset(l.bank,l.program)}return g=u.getSamplesAndGenerators(A,e).reduce((l,Q)=>{if(Q.sample.sampleData===void 0)return H(`Discarding invalid sample: ${Q.sample.sampleName}`),l;let p=new Int16Array(60);for(let G=0;G<60;G++)p[G]=Ss(G,Q.presetGenerators,Q.instrumentGenerators);p[a.initialAttenuation]=Math.floor(p[a.initialAttenuation]*.4);let y=Q.sample.samplePitch;p[a.overridingRootKey]>-1&&(y=p[a.overridingRootKey]);let w=A;p[a.keyNum]>-1&&(w=p[a.keyNum]);let k=Q.sample.sampleLoopStartIndex,L=Q.sample.sampleLoopEndIndex,R=p[a.sampleModes],N=new Ct(Q.sample.getAudioData(),Q.sample.sampleRate/sampleRate*Math.pow(2,Q.sample.samplePitchCorrection/1200),0,y,k,L,Math.floor(Q.sample.sampleData.length)-1,R);return p[a.velocity]>-1&&(e=p[a.velocity]),i&&ys([{Sample:Q.sample.sampleName,Generators:p,Modulators:Q.modulators.map(G=>G.debugString()),Velocity:e,TargetKey:w,MidiNote:A,WorkletSample:N}]),l.push(new be(sampleRate,N,A,e,t,n,w,o,p,Q.modulators.map(G=>_.copy(G)))),l},[]),d&&(s.cachedVoices[A][e]=g.map(l=>be.copy(l,n))),g}var $o=4600,Ar=2e3,So=Math.PI/2;function Do(t,A,e,s,n,o){if(isNaN(A[0]))return;let i=(Math.max(-500,Math.min(500,t.modulatedGenerators[a.pan]))+500)/1e3;t.currentPan+=(i-t.currentPan)*this.panSmoothingFactor;let g=this.currentGain,B=Math.cos(So*t.currentPan)*g*this.panLeft,h=Math.sin(So*t.currentPan)*g*this.panRight,d=this.reverbGain*t.modulatedGenerators[a.reverbEffectsSend]/$o*g,u=this.chorusGain*t.modulatedGenerators[a.chorusEffectsSend]/Ar;if(d>0&&!this.oneOutputMode){let l=n[0],Q=n[1];for(let p=0;p<A.length;p++)l[p]+=d*A[p],Q[p]+=d*A[p]}if(u>0&&!this.oneOutputMode){let l=o[0],Q=o[1],p=B*u,y=h*u;for(let w=0;w<A.length;w++)l[w]+=p*A[w],Q[w]+=y*A[w]}if(B>0)for(let l=0;l<A.length;l++)e[l]+=B*A[l];if(h>0)for(let l=0;l<A.length;l++)s[l]+=h*A[l]}var on=.03,cn=.07,Yt=1,Y=class extends AudioWorkletProcessor{constructor(A){super(),this.oneOutputMode=A.processorOptions?.startRenderingData?.oneOutput===!0,this._outputsAmount=this.oneOutputMode?1:A.processorOptions.midiChannels,this.enableEventSystem=A.processorOptions.enableEventSystem,this.alive=!0,this.deviceID=HA,this.interpolationType=Qe.fourthOrder,this.processTickCallback=void 0,this.sequencer=new rA(this),this.transposition=0,this.tunings=[];for(let e=0;e<127;e++)this.tunings.push([]);this.soundfontBankOffset=0,this.masterGain=Yt,this.midiVolume=1,this.reverbGain=1,this.chorusGain=1,this.voiceCap=ws,this.pan=0,this.panLeft=.5,this.highPerformanceMode=!1,this.keyModifierManager=new We,this.overrideSoundfont=void 0,this.panRight=.5;try{this.soundfontManager=new gt(A.processorOptions.soundfont,this.postReady.bind(this))}catch(e){throw this.post({messageType:uA.soundfontError,messageData:e}),e}this.sendPresetList(),this.defaultPreset=this.getPreset(0,0),this.drumPreset=this.getPreset(128,0),this.workletProcessorChannels=[];for(let e=0;e<A.processorOptions.midiChannels;e++)this.createWorkletChannel(!1);this.workletProcessorChannels[SA].preset=this.drumPreset,this.workletProcessorChannels[SA].drumChannel=!0,this.volumeEnvelopeSmoothingFactor=An*(sampleRate/44100),this.panSmoothingFactor=en*(sampleRate/44100),this.system=ze,this.totalVoicesAmount=0,this._snapshot=A.processorOptions?.startRenderingData?.snapshot,this.port.onmessage=e=>this.handleMessage(e.data),A.processorOptions.startRenderingData&&(this._snapshot!==void 0&&(this.applySynthesizerSnapshot(this._snapshot),this.resetAllControllers()),m("%cRendering enabled! Starting render.",r.info),A.processorOptions.startRenderingData.parsedMIDI&&(A.processorOptions.startRenderingData?.loopCount!==void 0?(this.sequencer.loopCount=A.processorOptions.startRenderingData?.loopCount,this.sequencer.loop=!0):this.sequencer.loop=!1,this.sequencer.loadNewSongList([A.processorOptions.startRenderingData.parsedMIDI]))),VA.isInitialized.then(()=>{this.postReady(),m("%cSpessaSynth is ready!",r.recognized)})}get currentGain(){return this.masterGain*this.midiVolume}post(A){this.enableEventSystem&&this.port.postMessage(A)}postReady(){this.enableEventSystem&&this.port.postMessage({messageType:uA.ready,messageData:void 0})}debugMessage(){m({channels:this.workletProcessorChannels,voicesAmount:this.totalVoicesAmount,outputAmount:this._outputsAmount,dumpedSamples:this.workletDumpedSamplesList})}process(A,e){if(!this.alive)return!1;this.processTickCallback&&this.processTickCallback();let s=0;return this.workletProcessorChannels.forEach((n,o)=>{if(n.voices.length<1||n.isMuted)return;let i,g,B,h,d;if(this.oneOutputMode){let l=e[0];i=o%16*2,g=l[i],B=l[i+1]}else i=o%this._outputsAmount+2,g=e[i][0],B=e[i][1],h=e[0],d=e[1];let u=n.voices;n.voices=[],u.forEach(l=>{this.renderVoice(n,l,g,B,h,d),l.finished||n.voices.push(l)}),s+=n.voices.length}),s!==this.totalVoicesAmount&&(this.totalVoicesAmount=s,this.sendChannelProperties()),!0}destroyWorkletProcessor(){this.alive=!1,this.workletProcessorChannels.forEach(A=>{delete A.midiControllers,delete A.voices,delete A.sustainedVoices,delete A.cachedVoices,delete A.lockedControllers,delete A.preset,delete A.customControllers}),delete this.workletProcessorChannels,delete this.sequencer.midiData,delete this.sequencer,this.soundfontManager.destroyManager(),delete this.soundfontManager}};Y.prototype.renderVoice=tn;Y.prototype.releaseVoice=nn;Y.prototype.voiceKilling=sn;Y.prototype.getWorkletVoices=yo;Y.prototype.handleMessage=In;Y.prototype.sendChannelProperties=Cn;Y.prototype.callEvent=gn;Y.prototype.systemExclusive=En;Y.prototype.noteOn=hn;Y.prototype.noteOff=Qn;Y.prototype.polyPressure=Fn;Y.prototype.killNote=ln;Y.prototype.stopAll=un;Y.prototype.stopAllChannels=dn;Y.prototype.muteChannel=bn;Y.prototype.setVibrato=Un;Y.prototype.disableAndLockGSNRPN=Ln;Y.prototype.dataEntryCoarse=Tn;Y.prototype.dataEntryFine=Hn;Y.prototype.createWorkletChannel=Ds;Y.prototype.controllerChange=Gn;Y.prototype.channelPressure=wn;Y.prototype.resetAllControllers=Yn;Y.prototype.resetControllers=vn;Y.prototype.resetParameters=Jn;Y.prototype.setMasterGain=xn;Y.prototype.setMasterPan=Nn;Y.prototype.setMIDIVolume=Mn;Y.prototype.transposeAllChannels=fn;Y.prototype.transposeChannel=mn;Y.prototype.setChannelTuning=pn;Y.prototype.setChannelTuningSemitones=yn;Y.prototype.setMasterTuning=Sn;Y.prototype.setModulationDepth=Dn;Y.prototype.pitchWheel=kn;Y.prototype.setOctaveTuning=Rn;Y.prototype.programChange=Eo;Y.prototype.getPreset=Bo;Y.prototype.setPreset=ho;Y.prototype.setDrums=co;Y.prototype.reloadSoundFont=uo;Y.prototype.clearSoundFont=lo;Y.prototype.setEmbeddedSoundFont=fo;Y.prototype.sendPresetList=Qo;Y.prototype.sendSynthesizerSnapshot=mo;Y.prototype.applySynthesizerSnapshot=po;Y.prototype.panVoice=Do;registerProcessor(ks,Y);m("%cProcessor succesfully registered!",r.recognized);
