var bt=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(A,t)=>(typeof require<"u"?require:A)[t]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var M=class extends Uint8Array{constructor(A){super(A),this.currentIndex=0}currentIndex};function ce(e){let A=e.reduce((s,n)=>s+n.length,0),t=new M(A),I=0;for(let s of e)t.set(s,I),I+=s.length;return t}function Pe(e){e=Math.floor(e);let A=Math.floor(e/60),t=Math.round(e-A*60);return{minutes:A,seconds:t,time:`${A.toString().padStart(2,"0")}:${t.toString().padStart(2,"0")}`}}function Lt(e){return e.trim().replaceAll(".mid","").replaceAll(".rmi","").replaceAll("_"," ")}function CA(e){let A="";for(let t=0;t<e.length;t++){let I=e[t].toString(16).padStart(2,"0").toUpperCase();A+=I,A+=" "}return A}var C={warn:"color: orange;",unrecognized:"color: red;",info:"color: aqua;",recognized:"color: lime",value:"color: yellow; background-color: black;"};var de=class{constructor(A,t,I){this.ticks=A,this.messageStatusByte=t,this.messageData=I}};function Ht(e){let A=e&240,t=e&15,I=t;switch(A){case 128:case 144:case 160:case 176:case 192:case 208:case 224:break;case 240:switch(t){case 0:I=-3;break;case 1:case 2:case 3:case 4:case 5:case 6:case 7:case 8:case 9:case 10:case 11:case 12:case 13:case 14:I=-1;break;case 15:I=-2;break}break;default:I=-1}return I}var S={noteOff:128,noteOn:144,polyPressure:160,controllerChange:176,programChange:192,channelPressure:208,pitchBend:224,systemExclusive:240,timecode:241,songPosition:242,songSelect:243,tuneRequest:246,clock:248,start:250,continue:251,stop:252,activeSensing:254,reset:255,sequenceNumber:0,text:1,copyright:2,trackName:3,instrumentName:4,lyric:5,marker:6,cuePoint:7,midiChannelPrefix:32,midiPort:33,endOfTrack:47,setTempo:81,smpteOffset:84,timeSignature:88,keySignature:89,sequenceSpecific:127};function Ie(e){let A=e&240,t=e&15,I=-1,s=e;return A>=128&&A<=224&&(I=t,s=A),{status:s,channel:I}}var p={bankSelect:0,modulationWheel:1,breathController:2,footController:4,portamentoTime:5,dataEntryMsb:6,mainVolume:7,balance:8,pan:10,expressionController:11,effectControl1:12,effectControl2:13,generalPurposeController1:16,generalPurposeController2:17,generalPurposeController3:18,generalPurposeController4:19,lsbForControl0BankSelect:32,lsbForControl1ModulationWheel:33,lsbForControl2BreathController:34,lsbForControl4FootController:36,lsbForControl5PortamentoTime:37,lsbForControl6DataEntry:38,lsbForControl7MainVolume:39,lsbForControl8Balance:40,lsbForControl10Pan:42,lsbForControl11ExpressionController:43,lsbForControl12EffectControl1:44,lsbForControl13EffectControl2:45,sustainPedal:64,portamentoOnOff:65,sostenutoPedal:66,softPedal:67,legatoFootswitch:68,hold2Pedal:69,soundVariation:70,timbreHarmonicContent:71,releaseTime:72,attackTime:73,brightness:74,soundController6:75,soundController7:76,soundController8:77,soundController9:78,soundController10:79,generalPurposeController5:80,generalPurposeController6:81,generalPurposeController7:82,generalPurposeController8:83,portamentoControl:84,effects1Depth:91,effects2Depth:92,effects3Depth:93,effects4Depth:94,effects5Depth:95,dataIncrement:96,dataDecrement:97,NRPNLsb:98,NRPNMsb:99,RPNLsb:100,RPNMsb:101,allSoundOff:120,resetAllControllers:121,localControlOnOff:122,allNotesOff:123,omniModeOff:124,omniModeOn:125,monoModeOn:126,polyModeOn:127},Yt={8:2,9:2,10:2,11:2,12:1,13:1,14:2};var O={noteOff:0,noteOn:1,ccChange:2,programChange:3,channelPressure:4,polyPressure:5,killNote:6,ccReset:7,setChannelVibrato:8,reloadSoundFont:9,stopAll:10,killNotes:11,muteChannel:12,addNewChannel:13,customcCcChange:14,debugMessage:15,systemExclusive:16,setMasterParameter:17,setDrums:18,pitchWheel:19,transpose:20,highPerformanceMode:21,lockController:22,sequencerSpecific:23,requestSynthesizerSnapshot:24},se={mainVolume:0,masterPan:1,voicesCap:2},KA=-1,hA={channelProperties:0,eventCall:1,reportedCurrentTime:2,sequencerSpecific:3,synthesizerSnapshot:4,ready:5,soundfontError:6};var Zs=!0,Os=!0,Ze=!0,vs=!0;function m(...e){Zs&&console.info(...e)}function J(...e){Os&&console.warn(...e)}function Jt(...e){vs&&console.table(...e)}function Tt(...e){Ze&&console.group(...e)}function HA(...e){Ze&&console.groupCollapsed(...e)}function IA(){Ze&&console.groupEnd()}var qt="spessasynth-worklet-system",Kt=450,kA=9,ue=16,fe="gs";function H(e,A){let t=0;for(let I=0;I<A;I++)t|=e[e.currentIndex++]<<I*8;return t>>>0}function oe(e,A,t){for(let I=0;I<t;I++)e[e.currentIndex++]=A>>I*8&255}function G(e,A){e[e.currentIndex++]=A&255,e[e.currentIndex++]=A>>8}function nA(e,A){oe(e,A,4)}function me(e,A){let t=A<<8|e;return t>32767?t-65536:t}function Vt(e){return e>127?e-256:e}function _(e,A,t=void 0,I=!0){if(t){let s=e.slice(e.currentIndex,e.currentIndex+A);return e.currentIndex+=A,new TextDecoder(t).decode(s.buffer)}else{let s=!1,n="";for(let i=0;i<A;i++){let B=e[e.currentIndex++];if(!s){if(B<32||B>127){if(I){s=!0;continue}else if(B===0){s=!0;continue}}n+=String.fromCharCode(B)}}return n}}function dA(e,A,t=0){t>0&&A.length>t&&(A=A.slice(0,t));for(let I=0;I<A.length;I++)e[e.currentIndex++]=A.charCodeAt(I);if(t>A.length)for(let I=0;I<t-A.length;I++)e[e.currentIndex++]=0;return e}var K=class{constructor(A,t,I){this.header=A,this.size=t,this.chunkData=I}};function sA(e,A=!0,t=!1){let I=_(e,4),s=H(e,4),n;return A&&(n=new M(s),n.set(e.slice(e.currentIndex,e.currentIndex+s))),(A||t)&&(e.currentIndex+=s),new K(I,s,n)}function v(e,A=void 0){let t=8+e.size;e.size%2!==0&&t++,A&&(t+=A.length);let I=new M(t);return A&&(I.set(A,I.currentIndex),I.currentIndex+=A.length),dA(I,e.header),nA(I,t-8-(A?.length||0)),I.set(e.chunkData,I.currentIndex),I}var a={startAddrsOffset:0,endAddrOffset:1,startloopAddrsOffset:2,endloopAddrsOffset:3,startAddrsCoarseOffset:4,modLfoToPitch:5,vibLfoToPitch:6,modEnvToPitch:7,initialFilterFc:8,initialFilterQ:9,modLfoToFilterFc:10,modEnvToFilterFc:11,endAddrsCoarseOffset:12,modLfoToVolume:13,unused1:14,chorusEffectsSend:15,reverbEffectsSend:16,pan:17,unused2:18,unused3:19,unused4:20,delayModLFO:21,freqModLFO:22,delayVibLFO:23,freqVibLFO:24,delayModEnv:25,attackModEnv:26,holdModEnv:27,decayModEnv:28,sustainModEnv:29,releaseModEnv:30,keyNumToModEnvHold:31,keyNumToModEnvDecay:32,delayVolEnv:33,attackVolEnv:34,holdVolEnv:35,decayVolEnv:36,sustainVolEnv:37,releaseVolEnv:38,keyNumToVolEnvHold:39,keyNumToVolEnvDecay:40,instrument:41,reserved1:42,keyRange:43,velRange:44,startloopAddrsCoarseOffset:45,keyNum:46,velocity:47,initialAttenuation:48,reserved2:49,endloopAddrsCoarseOffset:50,coarseTune:51,fineTune:52,sampleID:53,sampleModes:54,reserved3:55,scaleTuning:56,exclusiveClass:57,overridingRootKey:58,unused5:59,endOper:60},F=[];F[a.startAddrsOffset]={min:0,max:32768,def:0};F[a.endAddrOffset]={min:-32768,max:32768,def:0};F[a.startloopAddrsOffset]={min:-32768,max:32768,def:0};F[a.endloopAddrsOffset]={min:-32768,max:32768,def:0};F[a.startAddrsCoarseOffset]={min:0,max:32768,def:0};F[a.modLfoToPitch]={min:-12e3,max:12e3,def:0};F[a.vibLfoToPitch]={min:-12e3,max:12e3,def:0};F[a.modEnvToPitch]={min:-12e3,max:12e3,def:0};F[a.initialFilterFc]={min:1500,max:13500,def:13500};F[a.initialFilterQ]={min:0,max:960,def:0};F[a.modLfoToFilterFc]={min:-12e3,max:12e3,def:0};F[a.modEnvToFilterFc]={min:-12e3,max:12e3,def:0};F[a.endAddrsCoarseOffset]={min:-32768,max:32768,def:0};F[a.modLfoToVolume]={min:-960,max:960,def:0};F[a.chorusEffectsSend]={min:0,max:1e3,def:0};F[a.reverbEffectsSend]={min:0,max:1e3,def:0};F[a.pan]={min:-500,max:500,def:0};F[a.delayModLFO]={min:-12e3,max:5e3,def:-12e3};F[a.freqModLFO]={min:-16e3,max:4500,def:0};F[a.delayVibLFO]={min:-12e3,max:5e3,def:-12e3};F[a.freqVibLFO]={min:-16e3,max:4500,def:0};F[a.delayModEnv]={min:-12e3,max:5e3,def:-12e3};F[a.attackModEnv]={min:-12e3,max:8e3,def:-12e3};F[a.holdModEnv]={min:-12e3,max:5e3,def:-12e3};F[a.decayModEnv]={min:-12e3,max:8e3,def:-12e3};F[a.sustainModEnv]={min:0,max:1e3,def:0};F[a.releaseModEnv]={min:-12e3,max:8e3,def:-12e3};F[a.keyNumToModEnvHold]={min:-1200,max:1200,def:0};F[a.keyNumToModEnvDecay]={min:-1200,max:1200,def:0};F[a.delayVolEnv]={min:-12e3,max:5e3,def:-12e3};F[a.attackVolEnv]={min:-12e3,max:8e3,def:-12e3};F[a.holdVolEnv]={min:-12e3,max:5e3,def:-12e3};F[a.decayVolEnv]={min:-12e3,max:8e3,def:-12e3};F[a.sustainVolEnv]={min:0,max:1440,def:0};F[a.releaseVolEnv]={min:-7200,max:8e3,def:-12e3};F[a.keyNumToVolEnvHold]={min:-1200,max:1200,def:0};F[a.keyNumToVolEnvDecay]={min:-1200,max:1200,def:0};F[a.startloopAddrsCoarseOffset]={min:-32768,max:32768,def:0};F[a.keyNum]={min:-1,max:127,def:-1};F[a.velocity]={min:-1,max:127,def:-1};F[a.initialAttenuation]={min:-250,max:1440,def:0};F[a.endloopAddrsCoarseOffset]={min:-32768,max:32768,def:0};F[a.coarseTune]={min:-120,max:120,def:0};F[a.fineTune]={min:-99,max:99,def:0};F[a.scaleTuning]={min:0,max:1200,def:100};F[a.exclusiveClass]={min:0,max:99999,def:0};F[a.overridingRootKey]={min:-1,max:127,def:-1};function Pt(e,A,t){let I=F[e]||{min:0,max:32768,def:0},s=A.find(Q=>Q.generatorType===e),n=0;s&&(n=s.generatorValue);let i=t.find(Q=>Q.generatorType===e),B=I.def;return i&&(B=i.generatorValue),Math.max(I.min,Math.min(I.max,B+n))}var Oe=class{constructor(A){let t=A.currentIndex;this.generatorType=A[t+1]<<8|A[t],this.generatorValue=me(A[t+2],A[t+3]),A.currentIndex+=4}};function ve(e){let A=[];for(;e.chunkData.length>e.chunkData.currentIndex;)A.push(new Oe(e.chunkData));return A.length>1&&A.pop(),A}var b={noController:0,noteOnVelocity:2,noteOnKeyNum:3,polyPressure:10,channelPressure:13,pitchWheel:14,pitchWheelRange:16,link:127},lA={linear:0,concave:1,convex:2,switch:3},Xs=[];for(let e=0;e<4;e++)Xs.push([[],[]]);var rA=class e{constructor(A){A.srcEnum?(this.modulatorSource=A.srcEnum,this.modulatorDestination=A.dest,this.modulationSecondarySrc=A.secSrcEnum,this.transformAmount=A.amt,this.transformType=A.transform):(this.modulatorSource=H(A,2),this.modulatorDestination=H(A,2),this.transformAmount=me(A[A.currentIndex++],A[A.currentIndex++]),this.modulationSecondarySrc=H(A,2),this.transformType=H(A,2)),this.modulatorDestination>58&&(this.modulatorDestination=-1),this.sourcePolarity=this.modulatorSource>>9&1,this.sourceDirection=this.modulatorSource>>8&1,this.sourceUsesCC=this.modulatorSource>>7&1,this.sourceIndex=this.modulatorSource&127,this.sourceCurveType=this.modulatorSource>>10&3,this.secSrcPolarity=this.modulationSecondarySrc>>9&1,this.secSrcDirection=this.modulationSecondarySrc>>8&1,this.secSrcUsesCC=this.modulationSecondarySrc>>7&1,this.secSrcIndex=this.modulationSecondarySrc&127,this.secSrcCurveType=this.modulationSecondarySrc>>10&3}sumTransform(A){return new e({srcEnum:this.modulatorSource,secSrcEnum:this.modulationSecondarySrc,dest:this.modulatorDestination,transform:this.transformType,amt:this.transformAmount+A.transformAmount})}debugString(){function A(s,n){return Object.keys(s).find(i=>s[i]===n)}let t=A(lA,this.sourceCurveType);t+=this.sourcePolarity===0?" unipolar ":" bipolar ",t+=this.sourceDirection===0?"forwards ":"backwards ",this.sourceUsesCC?t+=A(p,this.sourceIndex):t+=A(b,this.sourceIndex);let I=A(lA,this.secSrcCurveType);return I+=this.secSrcPolarity===0?" unipolar ":" bipolar ",I+=this.secSrcCurveType===0?"forwards ":"backwards ",this.secSrcUsesCC?I+=A(p,this.secSrcIndex):I+=A(b,this.secSrcIndex),`Modulator:
        Source: ${t}
        Secondary source: ${I}
