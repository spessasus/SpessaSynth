var ss=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(A,t)=>(typeof require<"u"?require:A)[t]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var H=class extends Uint8Array{constructor(A){super(A),this.currentIndex=0}currentIndex};function de(e){let A=e.reduce((n,o)=>n+o.length,0),t=new H(A),s=0;for(let n of e)t.set(n,s),s+=n.length;return t}function Bt(e){e=Math.floor(e);let A=Math.floor(e/60),t=Math.round(e-A*60);return{minutes:A,seconds:t,time:`${A.toString().padStart(2,"0")}:${t.toString().padStart(2,"0")}`}}function ns(e){return e.trim().replaceAll(".mid","").replaceAll(".rmi","").replaceAll("_"," ")}function hA(e){let A="";for(let t=0;t<e.length;t++){let s=e[t].toString(16).padStart(2,"0").toUpperCase();A+=s,A+=" "}return A}var a={warn:"color: orange;",unrecognized:"color: red;",info:"color: aqua;",recognized:"color: lime",value:"color: yellow; background-color: black;"};var ne=class{constructor(A,t,s){this.ticks=A,this.messageStatusByte=t,this.messageData=s}};function os(e){let A=e&240,t=e&15,s=t;switch(A){case 128:case 144:case 160:case 176:case 192:case 208:case 224:break;case 240:switch(t){case 0:s=-3;break;case 1:case 2:case 3:case 4:case 5:case 6:case 7:case 8:case 9:case 10:case 11:case 12:case 13:case 14:s=-1;break;case 15:s=-2;break}break;default:s=-1}return s}var w={noteOff:128,noteOn:144,polyPressure:160,controllerChange:176,programChange:192,channelPressure:208,pitchBend:224,systemExclusive:240,timecode:241,songPosition:242,songSelect:243,tuneRequest:246,clock:248,start:250,continue:251,stop:252,activeSensing:254,reset:255,sequenceNumber:0,text:1,copyright:2,trackName:3,instrumentName:4,lyric:5,marker:6,cuePoint:7,midiChannelPrefix:32,midiPort:33,endOfTrack:47,setTempo:81,smpteOffset:84,timeSignature:88,keySignature:89,sequenceSpecific:127};function me(e){let A=e&240,t=e&15,s=-1,n=e;return A>=128&&A<=224&&(s=t,n=A),{status:n,channel:s}}var S={bankSelect:0,modulationWheel:1,breathController:2,footController:4,portamentoTime:5,dataEntryMsb:6,mainVolume:7,balance:8,pan:10,expressionController:11,effectControl1:12,effectControl2:13,generalPurposeController1:16,generalPurposeController2:17,generalPurposeController3:18,generalPurposeController4:19,lsbForControl0BankSelect:32,lsbForControl1ModulationWheel:33,lsbForControl2BreathController:34,lsbForControl4FootController:36,lsbForControl5PortamentoTime:37,lsbForControl6DataEntry:38,lsbForControl7MainVolume:39,lsbForControl8Balance:40,lsbForControl10Pan:42,lsbForControl11ExpressionController:43,lsbForControl12EffectControl1:44,lsbForControl13EffectControl2:45,sustainPedal:64,portamentoOnOff:65,sostenutoPedal:66,softPedal:67,legatoFootswitch:68,hold2Pedal:69,soundVariation:70,timbreHarmonicContent:71,releaseTime:72,attackTime:73,brightness:74,soundController6:75,soundController7:76,soundController8:77,soundController9:78,soundController10:79,generalPurposeController5:80,generalPurposeController6:81,generalPurposeController7:82,generalPurposeController8:83,portamentoControl:84,effects1Depth:91,effects2Depth:92,effects3Depth:93,effects4Depth:94,effects5Depth:95,dataIncrement:96,dataDecrement:97,NRPNLsb:98,NRPNMsb:99,RPNLsb:100,RPNMsb:101,allSoundOff:120,resetAllControllers:121,localControlOnOff:122,allNotesOff:123,omniModeOff:124,omniModeOn:125,monoModeOn:126,polyModeOn:127},rs={8:2,9:2,10:2,11:2,12:1,13:1,14:2};var AA={noteOff:0,noteOn:1,ccChange:2,programChange:3,channelPressure:4,polyPressure:5,killNote:6,ccReset:7,setChannelVibrato:8,soundFontManager:9,stopAll:10,killNotes:11,muteChannel:12,addNewChannel:13,customcCcChange:14,debugMessage:15,systemExclusive:16,setMasterParameter:17,setDrums:18,pitchWheel:19,transpose:20,highPerformanceMode:21,lockController:22,sequencerSpecific:23,requestSynthesizerSnapshot:24,setLogLevel:25},pe={mainVolume:0,masterPan:1,voicesCap:2},bA=-1,pA={channelProperties:0,eventCall:1,reportedCurrentTime:2,sequencerSpecific:3,synthesizerSnapshot:4,ready:5,soundfontError:6};var is=!0,Is=!0,Ue=!0,as=!0;function gs(e,A,t,s){is=e,Is=A,Ue=t,as=s}function p(...e){is&&console.info(...e)}function Y(...e){Is&&console.warn(...e)}function Cs(...e){as&&console.table(...e)}function jA(...e){Ue&&console.group(...e)}function DA(...e){Ue&&console.groupCollapsed(...e)}function X(){Ue&&console.groupEnd()}var oe={reloadSoundFont:0,addNewSoundFont:2,deleteSoundFont:3,rearrangeSoundFonts:4};var Es="spessasynth-worklet-system",Bs=450,MA=9,Te=16,He="gs";var NA={loadNewSongList:0,pause:1,stop:2,play:3,setTime:4,changeMIDIMessageSending:5,setPlaybackRate:6,setLoop:7,changeSong:8,getMIDI:9,setSkipToFirstNote:10},kA={midiEvent:0,songChange:1,textEvent:2,timeChange:3,pause:4,getMIDI:5,midiError:6};function XA(e,A){let t=0;for(let s=8*(A-1);s>=0;s-=8)t|=e[e.currentIndex++]<<s;return t>>>0}function hs(e,A){if(this.ignoreEvents)return;if(this.sendMIDIMessages&&e.messageStatusByte>=128){this.sendMIDIMessage([e.messageStatusByte,...e.messageData]);return}let t=me(e.messageStatusByte),s=this.midiPortChannelOffsets[this.midiPorts[A]]||0;switch(t.channel+=s,t.status){case w.noteOn:let n=e.messageData[1];if(n>0)this.synth.noteOn(t.channel,e.messageData[0],n),this.playingNotes.push({midiNote:e.messageData[0],channel:t.channel,velocity:n,startTime:this.currentTime});else{this.synth.noteOff(t.channel,e.messageData[0]);let E=this.playingNotes.findIndex(i=>i.midiNote===e.messageData[0]&&i.channel===t.channel);E!==-1&&this.playingNotes.splice(E,1)}break;case w.noteOff:this.synth.noteOff(t.channel,e.messageData[0]);let o=this.playingNotes.findIndex(E=>E.midiNote===e.messageData[0]&&E.channel===t.channel);o!==-1&&this.playingNotes.splice(o,1);break;case w.pitchBend:this.synth.pitchWheel(t.channel,e.messageData[1],e.messageData[0]);break;case w.controllerChange:this.synth.controllerChange(t.channel,e.messageData[0],e.messageData[1]);break;case w.programChange:this.synth.programChange(t.channel,e.messageData[0]);break;case w.polyPressure:this.synth.polyPressure(t.channel,e.messageData[0],e.messageData[1]);break;case w.channelPressure:this.synth.channelPressure(t.channel,e.messageData[0]);break;case w.systemExclusive:this.synth.systemExclusive(e.messageData,s);break;case w.setTempo:this.oneTickToSeconds=60/(ko(e)*this.midiData.timeDivision),this.oneTickToSeconds===0&&(this.oneTickToSeconds=60/(120*this.midiData.timeDivision),Y("invalid tempo! falling back to 120 BPM"));break;case w.timeSignature:case w.endOfTrack:case w.midiChannelPrefix:case w.songPosition:case w.activeSensing:case w.keySignature:break;case w.text:case w.lyric:case w.copyright:case w.trackName:case w.marker:case w.cuePoint:case w.instrumentName:this.post(kA.textEvent,[e.messageData,t.status]);break;case w.midiPort:this.assignMIDIPort(A,e.messageData[0]);break;case w.reset:this.synth.stopAllChannels(),this.synth.resetAllControllers();break;default:Y(`%cUnrecognized Event: %c${e.messageStatusByte}%c status byte: %c${Object.keys(w).find(E=>w[E]===t.status)}`,a.warn,a.unrecognized,a.warn,a.value);break}}function Qs(){for(let e=0;e<16;e++)this.synth.createWorkletChannel(!0),e===MA&&this.synth.setDrums(this.synth.workletProcessorChannels.length-1,!0)}function ko(e){return e.messageData.currentIndex=0,6e7/XA(e.messageData,3)}function cs(){let e=this.currentTime;for(;this.playedTime<e;){let A=this._findFirstEventIndex(),t=this.tracks[A][this.eventIndex[A]];if(this._processEvent(t,A),this.eventIndex[A]++,A=this._findFirstEventIndex(),this.tracks[A].length<=this.eventIndex[A]){if(this.loop){this.setTimeTicks(this.midiData.loop.start);return}this.eventIndex[A]--,this.pause(!0),this.songs.length>1&&this.nextSong();return}let s=this.tracks[A][this.eventIndex[A]];if(this.playedTime+=this.oneTickToSeconds*(s.ticks-t.ticks),this.midiData.loop.end<=t.ticks&&this.loop){this.setTimeTicks(this.midiData.loop.start);return}else if(e>=this.duration){if(this.loop){this.setTimeTicks(this.midiData.loop.start);return}this.eventIndex[A]--,this.pause(!0),this.songs.length>1&&this.nextSong();return}}}function ls(){let e=0,A=1/0;return this.tracks.forEach((t,s)=>{this.eventIndex[s]>=t.length||t[this.eventIndex[s]].ticks<A&&(e=s,A=t[this.eventIndex[s]].ticks)}),e}var JA=new Int16Array(127);JA[S.mainVolume]=100;JA[S.expressionController]=127;JA[S.pan]=64;JA[S.releaseTime]=64;JA[S.brightness]=64;JA[S.effects1Depth]=40;function fs(e,A=void 0){if(this.oneTickToSeconds=60/(120*this.midiData.timeDivision),this.synth.resetAllControllers(),this.sendMIDIMessages){this.sendMIDIMessage([w.reset]);for(let i=0;i<Te;i++)this.sendMIDIMessage([w.controllerChange|i,S.resetAllControllers,0])}this._resetTimers();let t=this.synth.workletProcessorChannels.length,s=Array(t).fill(8192),n=[];for(let i=0;i<t;i++)n.push({program:-1,bank:0,actualBank:0});let o=i=>i===S.dataDecrement||i===S.dataIncrement||i===S.dataEntryMsb||i===S.dataDecrement||i===S.lsbForControl6DataEntry||i===S.RPNLsb||i===S.RPNMsb||i===S.NRPNLsb||i===S.NRPNMsb||i===S.bankSelect||i===S.lsbForControl0BankSelect||i===S.resetAllControllers,E=[];for(let i=0;i<t;i++)E.push(Array.from(JA));for(;;){let i=this._findFirstEventIndex(),h=this.tracks[i][this.eventIndex[i]];if(A!==void 0){if(h.ticks>=A)break}else if(this.playedTime>=e)break;let Q=me(h.messageStatusByte),u=Q.channel+(this.midiPortChannelOffsets[this.midiPorts[i]]||0);switch(Q.status){case w.noteOn:case w.noteOff:case w.keySignature:break;case w.pitchBend:s[u]=h.messageData[1]<<7|h.messageData[0];break;case w.programChange:let c=n[u];c.program=h.messageData[0],c.actualBank=c.bank;break;case w.controllerChange:let f=h.messageData[0];if(o(f))if(this.sendMIDIMessages)this.sendMIDIMessage([w.controllerChange|u%16,f,h.messageData[1]]);else{let m=h.messageData[1];if(f===S.bankSelect){n[u].bank=m;break}this.synth.controllerChange(u,f,m)}else E[u]===void 0&&(E[u]=Array.from(JA)),E[u][f]=h.messageData[1];break;default:this._processEvent(h,i);break}this.eventIndex[i]++,i=this._findFirstEventIndex();let l=this.tracks[i][this.eventIndex[i]];if(l===void 0)return this.stop(),!1;this.playedTime+=this.oneTickToSeconds*(l.ticks-h.ticks)}if(this.sendMIDIMessages){for(let i=0;i<t;i++)if(this.sendMIDIMessage([w.pitchBend|i%16,s[i]&127,s[i]>>7]),E[i].forEach((h,Q)=>{h!==JA[Q]&&!o(Q)&&this.sendMIDIMessage([w.controllerChange|i%16,Q,h])}),n[i].program>=0&&n[i].actualBank>=0){let h=n[i].actualBank;this.sendMIDIMessage([w.controllerChange|i%16,S.bankSelect,h]),this.sendMIDIMessage([w.programChange|i%16,n[i].program])}}else for(let i=0;i<t;i++)if(s[i]!==void 0&&this.synth.pitchWheel(i,s[i]>>7,s[i]&127),E[i]!==void 0&&E[i].forEach((h,Q)=>{h!==JA[Q]&&!o(Q)&&this.synth.controllerChange(i,Q,h)}),n[i].program>=0&&n[i].actualBank>=0){let h=n[i].actualBank;this.synth.controllerChange(i,S.bankSelect,h),this.synth.programChange(i,n[i].program)}return!0}function us(e=!1){if(this.midiData!==void 0){if(e){this.currentTime=0;return}if(this.currentTime>=this.duration){this.currentTime=0;return}if(this.paused&&(this._recalculateStartTime(this.pausedTime),this.pausedTime=void 0),!this.sendMIDIMessages){let A=this.currentTime;this.playingNotes.forEach(t=>{let s=t.startTime-A;this.synth.noteOn(t.channel,t.midiNote,t.velocity,!1,!0,currentTime+s)})}this.setProcessHandler()}}function Ye(e,A,t){if(A<=0)return 0;let s=e.find(o=>o.ticks<A),n=A-s.ticks;return Ye(e,A-n,t)+n*60/(s.tempo*t)}function ds(e){this.stop(),this.playingNotes=[],this.pausedTime=void 0,this.post(kA.timeChange,currentTime-Ye(this.midiData.tempoChanges,e,this.midiData.timeDivision));let A=this._playTo(0,e);this._recalculateStartTime(this.playedTime),A&&this.play()}function ms(e){this.absoluteStartTime=currentTime-e/this._playbackRate}var Je=class{constructor(A){this.timeDivision=A.timeDivision,this.duration=A.duration,this.tempoChanges=A.tempoChanges,this.copyright=A.copyright,this.tracksAmount=A.tracksAmount,this.lyrics=A.lyrics,this.firstNoteOn=A.firstNoteOn,this.keyRange=A.keyRange,this.lastVoiceEventTick=A.lastVoiceEventTick,this.midiPorts=A.midiPorts,this.midiPortChannelOffsets=A.midiPortChannelOffsets,this.usedChannelsOnTrack=A.usedChannelsOnTrack,this.loop=A.loop,this.midiName=A.midiName,this.fileName=A.fileName,this.rawMidiName=A.rawMidiName,this.isEmbedded=A.embeddedSoundFont!==void 0,this.RMIDInfo=A.RMIDInfo,this.bankOffset=A.bankOffset}},Bi={duration:99999,firstNoteOn:0,loop:{start:0,end:123456},lastVoiceEventTick:123456,lyrics:[],copyright:"",midiPorts:[],midiPortChannelOffsets:[],tracksAmount:0,tempoChanges:[{ticks:0,tempo:120}],fileName:"NOT_LOADED.mid",midiName:"Loading...",rawMidiName:new Uint8Array([76,111,97,100,105,110,103,46,46,46]),usedChannelsOnTrack:[],timeDivision:0,keyRange:{min:0,max:127},isEmbedded:!1,RMIDInfo:void 0,bankOffset:0};function D(e,A){let t=0;for(let s=0;s<A;s++)t|=e[e.currentIndex++]<<s*8;return t>>>0}function re(e,A,t){for(let s=0;s<t;s++)e[e.currentIndex++]=A>>s*8&255}function J(e,A){e[e.currentIndex++]=A&255,e[e.currentIndex++]=A>>8}function cA(e,A){re(e,A,4)}function ie(e,A){let t=A<<8|e;return t>32767?t-65536:t}function ps(e){return e>127?e-256:e}function V(e,A,t=void 0,s=!0){if(t){let n=e.slice(e.currentIndex,e.currentIndex+A);return e.currentIndex+=A,new TextDecoder(t.replace(/[^\x20-\x7E]/g,"")).decode(n.buffer)}else{let n=!1,o="";for(let E=0;E<A;E++){let i=e[e.currentIndex++];if(!n){if(i<32||i>127){if(s){n=!0;continue}else if(i===0){n=!0;continue}}o+=String.fromCharCode(i)}}return o}}function wA(e,A,t=0){t>0&&A.length>t&&(A=A.slice(0,t));for(let s=0;s<A.length;s++)e[e.currentIndex++]=A.charCodeAt(s);if(t>A.length)for(let s=0;s<t-A.length;s++)e[e.currentIndex++]=0;return e}var j=class{constructor(A,t,s){this.header=A,this.size=t,this.chunkData=s}};function O(e,A=!0,t=!1){let s=V(e,4),n=D(e,4),o;return A&&(o=new H(e.buffer.slice(e.currentIndex,e.currentIndex+n))),(A||t)&&(e.currentIndex+=n),n%2!==0&&e[e.currentIndex]===0&&e.currentIndex++,new j(s,n,o)}function tA(e,A=void 0){let t=8+e.size;e.size%2!==0&&t++,A&&(t+=A.length);let s=new H(t);return A&&(s.set(A,s.currentIndex),s.currentIndex+=A.length),wA(s,e.header),cA(s,t-8-(A?.length||0)),s.set(e.chunkData,s.currentIndex),s}function SA(e,A){return e.find(t=>t.header!=="LIST"?!1:(t.chunkData.currentIndex=0,V(t.chunkData,4)===A))}function qe(e){let A=0;for(;e;){let t=e[e.currentIndex++];if(A=A<<7|t&127,t>>7!==1)break}return A}var g={INVALID:-1,startAddrsOffset:0,endAddrOffset:1,startloopAddrsOffset:2,endloopAddrsOffset:3,startAddrsCoarseOffset:4,modLfoToPitch:5,vibLfoToPitch:6,modEnvToPitch:7,initialFilterFc:8,initialFilterQ:9,modLfoToFilterFc:10,modEnvToFilterFc:11,endAddrsCoarseOffset:12,modLfoToVolume:13,unused1:14,chorusEffectsSend:15,reverbEffectsSend:16,pan:17,unused2:18,unused3:19,unused4:20,delayModLFO:21,freqModLFO:22,delayVibLFO:23,freqVibLFO:24,delayModEnv:25,attackModEnv:26,holdModEnv:27,decayModEnv:28,sustainModEnv:29,releaseModEnv:30,keyNumToModEnvHold:31,keyNumToModEnvDecay:32,delayVolEnv:33,attackVolEnv:34,holdVolEnv:35,decayVolEnv:36,sustainVolEnv:37,releaseVolEnv:38,keyNumToVolEnvHold:39,keyNumToVolEnvDecay:40,instrument:41,reserved1:42,keyRange:43,velRange:44,startloopAddrsCoarseOffset:45,keyNum:46,velocity:47,initialAttenuation:48,reserved2:49,endloopAddrsCoarseOffset:50,coarseTune:51,fineTune:52,sampleID:53,sampleModes:54,reserved3:55,scaleTuning:56,exclusiveClass:57,overridingRootKey:58,unused5:59,endOper:60},L=[];L[g.startAddrsOffset]={min:0,max:32768,def:0};L[g.endAddrOffset]={min:-32768,max:32768,def:0};L[g.startloopAddrsOffset]={min:-32768,max:32768,def:0};L[g.endloopAddrsOffset]={min:-32768,max:32768,def:0};L[g.startAddrsCoarseOffset]={min:0,max:32768,def:0};L[g.modLfoToPitch]={min:-12e3,max:12e3,def:0};L[g.vibLfoToPitch]={min:-12e3,max:12e3,def:0};L[g.modEnvToPitch]={min:-12e3,max:12e3,def:0};L[g.initialFilterFc]={min:1500,max:13500,def:13500};L[g.initialFilterQ]={min:0,max:960,def:0};L[g.modLfoToFilterFc]={min:-12e3,max:12e3,def:0};L[g.modEnvToFilterFc]={min:-12e3,max:12e3,def:0};L[g.endAddrsCoarseOffset]={min:-32768,max:32768,def:0};L[g.modLfoToVolume]={min:-960,max:960,def:0};L[g.chorusEffectsSend]={min:0,max:1e3,def:0};L[g.reverbEffectsSend]={min:0,max:1e3,def:0};L[g.pan]={min:-500,max:500,def:0};L[g.delayModLFO]={min:-12e3,max:5e3,def:-12e3};L[g.freqModLFO]={min:-16e3,max:4500,def:0};L[g.delayVibLFO]={min:-12e3,max:5e3,def:-12e3};L[g.freqVibLFO]={min:-16e3,max:4500,def:0};L[g.delayModEnv]={min:-12e3,max:5e3,def:-12e3};L[g.attackModEnv]={min:-12e3,max:8e3,def:-12e3};L[g.holdModEnv]={min:-12e3,max:5e3,def:-12e3};L[g.decayModEnv]={min:-12e3,max:8e3,def:-12e3};L[g.sustainModEnv]={min:0,max:1e3,def:0};L[g.releaseModEnv]={min:-12e3,max:8e3,def:-12e3};L[g.keyNumToModEnvHold]={min:-1200,max:1200,def:0};L[g.keyNumToModEnvDecay]={min:-1200,max:1200,def:0};L[g.delayVolEnv]={min:-12e3,max:5e3,def:-12e3};L[g.attackVolEnv]={min:-12e3,max:8e3,def:-12e3};L[g.holdVolEnv]={min:-12e3,max:5e3,def:-12e3};L[g.decayVolEnv]={min:-12e3,max:8e3,def:-12e3};L[g.sustainVolEnv]={min:0,max:1440,def:0};L[g.releaseVolEnv]={min:-7200,max:8e3,def:-12e3};L[g.keyNumToVolEnvHold]={min:-1200,max:1200,def:0};L[g.keyNumToVolEnvDecay]={min:-1200,max:1200,def:0};L[g.startloopAddrsCoarseOffset]={min:-32768,max:32768,def:0};L[g.keyNum]={min:-1,max:127,def:-1};L[g.velocity]={min:-1,max:127,def:-1};L[g.initialAttenuation]={min:-250,max:1440,def:0};L[g.endloopAddrsCoarseOffset]={min:-32768,max:32768,def:0};L[g.coarseTune]={min:-120,max:120,def:0};L[g.fineTune]={min:-99,max:99,def:0};L[g.scaleTuning]={min:0,max:1200,def:100};L[g.exclusiveClass]={min:0,max:99999,def:0};L[g.overridingRootKey]={min:-1,max:127,def:-1};var b=class{constructor(A=g.INVALID,t=0){if(this.generatorType=A,t===void 0)throw new Error("No value provided.");let s=L[A];this.generatorValue=Math.round(t),s!==void 0&&(this.generatorValue=Math.max(s.min,Math.min(s.max,this.generatorValue)))}generatorType=g.INVALID;generatorValue=0};function Ss(e,A,t){let s=L[e]||{min:0,max:32768,def:0},n=A.find(h=>h.generatorType===e),o=0;n&&(o=n.generatorValue);let E=t.find(h=>h.generatorType===e),i=s.def;return E&&(i=E.generatorValue),Math.max(s.min,Math.min(s.max,i+o))}var ht=class extends b{constructor(A){super();let t=A.currentIndex;this.generatorType=A[t+1]<<8|A[t],this.generatorValue=ie(A[t+2],A[t+3]),A.currentIndex+=4}};function Qt(e){let A=[];for(;e.chunkData.length>e.chunkData.currentIndex;)A.push(new ht(e.chunkData));return A.length>1&&A.pop(),A}var P={noController:0,noteOnVelocity:2,noteOnKeyNum:3,polyPressure:10,channelPressure:13,pitchWheel:14,pitchWheelRange:16,link:127},lA={linear:0,concave:1,convex:2,switch:3},wo=[];for(let e=0;e<4;e++)wo.push([[],[]]);var rA=class e{constructor(A){A.srcEnum?(this.modulatorSource=A.srcEnum,this.modulatorDestination=A.dest,this.modulationSecondarySrc=A.secSrcEnum,this.transformAmount=A.amt,this.transformType=A.transform):(this.modulatorSource=D(A,2),this.modulatorDestination=D(A,2),this.transformAmount=ie(A[A.currentIndex++],A[A.currentIndex++]),this.modulationSecondarySrc=D(A,2),this.transformType=D(A,2)),this.modulatorDestination>58&&(this.modulatorDestination=g.INVALID),this.sourcePolarity=this.modulatorSource>>9&1,this.sourceDirection=this.modulatorSource>>8&1,this.sourceUsesCC=this.modulatorSource>>7&1,this.sourceIndex=this.modulatorSource&127,this.sourceCurveType=this.modulatorSource>>10&3,this.secSrcPolarity=this.modulationSecondarySrc>>9&1,this.secSrcDirection=this.modulationSecondarySrc>>8&1,this.secSrcUsesCC=this.modulationSecondarySrc>>7&1,this.secSrcIndex=this.modulationSecondarySrc&127,this.secSrcCurveType=this.modulationSecondarySrc>>10&3}sumTransform(A){return new e({srcEnum:this.modulatorSource,secSrcEnum:this.modulationSecondarySrc,dest:this.modulatorDestination,transform:this.transformType,amt:this.transformAmount+A.transformAmount})}debugString(){function A(n,o){return Object.keys(n).find(E=>n[E]===o)}let t=A(lA,this.sourceCurveType);t+=this.sourcePolarity===0?" unipolar ":" bipolar ",t+=this.sourceDirection===0?"forwards ":"backwards ",this.sourceUsesCC?t+=A(S,this.sourceIndex):t+=A(P,this.sourceIndex);let s=A(lA,this.secSrcCurveType);return s+=this.secSrcPolarity===0?" unipolar ":" bipolar ",s+=this.secSrcCurveType===0?"forwards ":"backwards ",this.secSrcUsesCC?s+=A(S,this.secSrcIndex):s+=A(P,this.secSrcIndex),`Modulator:
        Source: ${t}
        Secondary source: ${s}
