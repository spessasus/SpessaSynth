...
`}};function qA(t,A,e,s,n){return t<<10|A<<9|e<<8|s<<7|n}var St=960,yt=cA.concave,Ze=[new eA({srcEnum:qA(yt,0,1,0,V.noteOnVelocity),dest:a.initialAttenuation,amt:St,secSrcEnum:0,transform:0}),new eA({srcEnum:129,dest:a.vibLfoToPitch,amt:50,secSrcEnum:0,transform:0}),new eA({srcEnum:qA(yt,0,1,1,p.mainVolume),dest:a.initialAttenuation,amt:St,secSrcEnum:0,transform:0}),new eA({srcEnum:13,dest:a.vibLfoToPitch,amt:50,secSrcEnum:0,transform:0}),new eA({srcEnum:526,dest:a.fineTune,amt:12700,secSrcEnum:16,transform:0}),new eA({srcEnum:650,dest:a.pan,amt:1e3,secSrcEnum:0,transform:0}),new eA({srcEnum:qA(yt,0,1,1,p.expressionController),dest:a.initialAttenuation,amt:St,secSrcEnum:0,transform:0}),new eA({srcEnum:219,dest:a.reverbEffectsSend,amt:750,secSrcEnum:0,transform:0}),new eA({srcEnum:221,dest:a.chorusEffectsSend,amt:750,secSrcEnum:0,transform:0}),new eA({srcEnum:qA(cA.linear,0,0,0,V.polyPressure),dest:a.vibLfoToPitch,amt:50,secSrcEnum:0,transform:0}),new eA({srcEnum:qA(cA.linear,0,0,1,p.effects2Depth),dest:a.modLfoToVolume,amt:24,secSrcEnum:0,transform:0}),new eA({srcEnum:qA(cA.linear,1,0,1,p.releaseTime),dest:a.releaseVolEnv,amt:1200,secSrcEnum:0,transform:0}),new eA({srcEnum:qA(cA.linear,1,0,1,p.brightness),dest:a.initialFilterFc,amt:4e3,secSrcEnum:0,transform:0})];function Xe(t){let A=[];for(;t.chunkData.length>t.chunkData.currentIndex;)A.push(new eA(t.chunkData));return A}function Ds(t=!1){let A={midiControllers:new Int16Array(Dt),lockedControllers:Array(Dt).fill(!1),customControllers:new Float32Array(ks),NRPCoarse:0,NRPFine:0,RPValue:0,dataEntryState:uA.Idle,voices:[],sustainedVoices:[],cachedVoices:[],preset:this.defaultPreset,presetUsesOverride:!1,channelTransposeKeyShift:0,channelOctaveTuning:new Int8Array(12),keyCentTuning:new Int16Array(128),channelVibrato:{delay:0,depth:0,rate:0},lockGSNRPNParams:!1,holdPedal:!1,isMuted:!1,drumChannel:!1,lockPreset:!1};for(let e=0;e<128;e++)A.cachedVoices.push([]);this.workletProcessorChannels.push(A),this.resetControllers(this.workletProcessorChannels.length-1),this.sendChannelProperties(),t&&this.callEvent("newchannel",void 0)}var EA=128,Dt=147,ZA=new Int16Array(Dt).fill(0);ZA[p.mainVolume]=12800;ZA[p.expressionController]=16256;ZA[p.pan]=8192;ZA[p.releaseTime]=8192;ZA[p.brightness]=8192;ZA[EA+V.pitchWheel]=8192;ZA[EA+V.pitchWheelRange]=256;var uA={Idle:0,RPCoarse:1,RPFine:2,NRPCoarse:3,NRPFine:4,DataCoarse:5,DataFine:6},IA={channelTuning:0,channelTransposeFine:1,modulationMultiplier:2,masterTuning:3,channelTuningSemitones:4},ks=Object.keys(IA).length,kt=new Float32Array(ks);kt[IA.modulationMultiplier]=1;var We={name:"INAM",album:"IPRD",artist:"IART",genre:"IGNR",picture:"IPIC",copyright:"ICOP",creationDate:"ICRD",comment:"ICMT",engineer:"IENG",software:"ISFT",encoding:"IENC",midiEncoding:"MENC",bankOffset:"DBNK"};var _e=class{constructor(){this.timeDivision=0,this.duration=0,this.tempoChanges=[{ticks:0,tempo:120}],this.copyright="",this.tracksAmount=0,this.lyrics=[],this.firstNoteOn=0,this.keyRange={min:0,max:127},this.lastVoiceEventTick=0,this.midiPorts=[0],this.midiPortChannelOffsets=[0],this.usedChannelsOnTrack=[],this.loop={start:0,end:0},this.midiName="",this.fileName="",this.rawMidiName=void 0,this.embeddedSoundFont=void 0,this.format=0,this.RMIDInfo={},this.bankOffset=0,this.tracks=[]}};function Ce(t,A){let e=0;for(;t>0;){let s=A.tempoChanges.find(o=>o.ticks<t),n=t-s.ticks;e+=n*60/(s.tempo*A.timeDivision),t-=n}return e}var xo=new Uint8Array([65,16,69,18,16,0,0]),ze=class extends _e{constructor(A,e=""){super(),SA("%cParsing MIDI File...",r.info);let s=new H(A),n,o=!1,g=!1,C=!1,c=O(s,4);if(s.currentIndex-=4,c==="RIFF"){s.currentIndex+=8;let D=O(s,4,void 0,!1);if(D!=="RMID")throw X(),new SyntaxError(`Invalid RMIDI Header! Expected "RMID", got "${D}"`);let w=Z(s);if(w.header!=="data")throw X(),new SyntaxError(`Invalid RMIDI Chunk header! Expected "data", got "${D}"`);for(n=w.chunkData;s.currentIndex<=s.length;){let F=s.currentIndex,v=Z(s,!0);if(v.header==="RIFF"){let M=O(v.chunkData,4).toLowerCase();M==="sfbk"||M==="sfpk"||M==="dls "?(m("%cFound embedded soundfont!",r.recognized),this.embeddedSoundFont=s.slice(F,F+v.size).buffer):b(`Unknown RIFF chunk: "${M}"`),M==="dls "&&(C=!0)}else if(v.header==="LIST"&&O(v.chunkData,4)==="INFO"){for(m("%cFound RMIDI INFO chunk!",r.recognized),this.RMIDInfo={};v.chunkData.currentIndex<=v.size;){let q=Z(v.chunkData,!0);this.RMIDInfo[q.header]=q.chunkData}this.RMIDInfo.ICOP&&(o=!0,this.copyright=O(this.RMIDInfo.ICOP,this.RMIDInfo.ICOP.length,void 0,!1).replaceAll(`
